...
namespace Server.Network {
	...
	public class NetState : IComparable<NetState>
	{
        ...
        private bool m_LogPackets = false;
        public bool LogPackets { get { return m_LogPackets; } set { m_LogPackets = value; } }

        public PacketSimulationLogger Logger = null;
        // end Alan's mod
		...
		public int AuthID{ get{ return m_AuthID; } set{ m_AuthID = value; } }
		...
		public virtual void Send( Packet p ) {
			...
			if ( buffer != null ) {
                ...
                if (m_LogPackets)
                {
                    if (Logger == null) Logger = new PacketSimulationLogger();
		...
		public ExpansionInfo SupportedExpansionInfo {
			get {
		...
		public Expansion SupportedExpansion
		{
			get {
				return ( Expansion ) this.SupportedExpansionInfo.ID;
			}
		}
