...
namespace Server {
	public static class World {
		...
		public static void Broadcast( AccessLevel level, int hue, bool ascii, string format, params object[] args )
		{
			Broadcast( level, hue, 3, ascii, String.Format( format, args ) );
		}
		...
		public static void Load() {
			...
			if ( failedItems || failedMobiles || failedMaps || failedGuilds ) {
		...
		public static void Save( bool message, bool permitBackgroundWrite ) {
			...
			Broadcast( message ? AccessLevel.Player : AccessLevel.GameMaster, 0x35, true, "The world is saving, please wait." );
			...
			Broadcast( message ? AccessLevel.Player : AccessLevel.GameMaster, 0x35, true, "World save complete. The entire process took {0:F1} seconds.", watch.Elapsed.TotalSeconds );
        ...
        public static List<Type> MobileTypes { get { return m_MobileTypes; }  }
