...
namespace Server.Gumps
{
	public class Gump
	{
		...
		public void AddLabelLocalized( int x, int y, int hue, int number )
		{
			Add( new GumpLabelLocalized( x, y, hue, number ) );
		}

		public void AddLabelLocalized( int x, int y, int hue, int number, params object[] args )
		{
			Add( new GumpLabelLocalized( x, y, hue, number, args ) );
		}

		public void AddLabelCroppedLocalized( int x, int y, int width, int height, int hue, int number )
		{
			Add( new GumpLabelCroppedLocalized( x, y, width, height, hue, number ) );
		}

		public void AddLabelCroppedLocalized( int x, int y, int width, int height, int hue, int number, params object[] args )
		{
			Add( new GumpLabelCroppedLocalized( x, y, width, height, hue, number, args ) );
		}
