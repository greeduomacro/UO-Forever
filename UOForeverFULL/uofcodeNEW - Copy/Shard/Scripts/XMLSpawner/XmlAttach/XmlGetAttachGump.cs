...
namespace Server.Mobiles
{
	public class XmlGetAttGump : Gump
	{
		...
		public XmlGetAttGump(Mobile from, object targeted, int x, int y)
			: this(
				from, targeted, true, false, false, false, false, null, null, false, 0, null, -1, 0, false, false, false, null, x, y
				)
		{ }
			...
			: base(X, Y)
		{
			...
			AddButton(415 + 25 * (MaxEntries / MaxEntriesPerPage), 450, 0x15E1, 0x15E5, 201, GumpButtonType.Reply, 0);
				// block forward
			...
			for (int i = 0; i < MaxEntries; i++)
			{
				...
				AddButton(
					620, 22 * (i % MaxEntriesPerPage) + 32, (sel ? 0xD3 : 0xD2), (sel ? 0xD2 : 0xD3), 4000 + i, GumpButtonType.Reply, 0);
			}
		}
		...
		public class XmlConfirmDeleteGump : Gump
		{
			...
			public XmlConfirmDeleteGump(
				Mobile from, object target, ArrayList searchlist, bool[] selectedlist, int displayfrom, bool selectall, int allcount)
				: base(0, 0)
			{
