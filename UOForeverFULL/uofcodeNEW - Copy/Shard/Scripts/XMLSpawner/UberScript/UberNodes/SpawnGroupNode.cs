...
{
    public class SpawnGroupNode : UberNode
    {
        ...
        public SpawnGroupNode(UberNode parent, string scriptInput, int lineNumber) : base(parent, scriptInput, lineNumber) { }
