...
{
    public class GroupCompetitionGump : Gump
    {
        ...
        public GroupCompetitionGump(Mobile from, int listPage, List<Mobile> list, List<Mobile> count, int check)
            : base(50, 50)
        {
            m_List = list;
            m_ListPage = listPage;
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            {
                m_check = 0;
                from.SendGump(new GroupCompetitionGump(from, m_ListPage, m_List, m_CountList, m_check));
            }
            ...
            {
                if (m_ListPage > 0)
                    from.SendGump(new GroupCompetitionGump(from, m_ListPage - 1, m_List, m_CountList, m_check));
            }
