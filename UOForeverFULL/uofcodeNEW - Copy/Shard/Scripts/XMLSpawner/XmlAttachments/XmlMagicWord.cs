...
namespace Server.Engines.XmlSpawner2
{
	public class XmlMagicWord : XmlAttachment
	{
		...
		private static readonly string[] keywordlist = new[]
		...
		private bool m_Identified;
					 // optional identification flag that can suppress application of the mod until identified when applied to items
		...
		public override string OnIdentify(Mobile from)
		{
			...
			{
				msg = String.Format(
					"{0} lasting {1} secs : {2} secs between uses", Word, Duration.TotalSeconds, Refractory.TotalSeconds);
			}
			else
			{
		...
		public override void OnSpeech(SpeechEventArgs e)
		{
			...
			if (AttachedTo is Mobile && AttachedTo != e.Mobile)
			{
				return;
			}
