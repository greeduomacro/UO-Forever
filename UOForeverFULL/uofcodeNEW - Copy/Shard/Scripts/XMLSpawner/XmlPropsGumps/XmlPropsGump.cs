...
namespace Server.Gumps
{
	public class XmlPropertiesGump : Gump
	{
		...
		private static readonly Type[] typeofReal = new[] {typeof(Single), typeof(Double)};

		private static readonly Type[] typeofNumeric = new[]
		{
		...
		public static object GetObjectFromString(Type t, string s)
		{
			...
			else if (t == typeof(byte) || t == typeof(sbyte) || t == typeof(short) || t == typeof(ushort) || t == typeof(int) ||
