	...
	public class XmlSetGump : Gump
	{
		...
		private class InternalPicker : HuePicker
		{
			...
			public override void OnResponse( int hue )
			{
				try
				{
                    CommandLogging.LogChangeProperty(m_Mobile, m_Object, m_Property.Name, m_Property.GetValue(m_Object, null).ToString(), hue.ToString());
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( shouldSet )
			{
				try
				{
                    CommandLogging.LogChangeProperty(m_Mobile, m_Object, m_Property.Name, m_Property.GetValue(m_Object, null).ToString(), toSet == null ? "(null)" : toSet.ToString());
