...
namespace Server.SkillHandlers
{
	public class DiscordanceInfo
	{
		...
		private readonly Mobile m_Creature;
		private readonly ArrayList m_Mods;
	...
	public class Discordance
	{
		...
		public static DiscordanceInfo GetDiscord(Mobile targ)
		{
		...
		private static void ProcessDiscordance(DiscordanceInfo info)
		{
			...
			if (ends && info.Ending && info.EndTime < DateTime.UtcNow)
			{
				if (info.Timer != null)
				{
					info.Timer.Stop();
