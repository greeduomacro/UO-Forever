...
namespace Server.SkillHandlers
{
	...
	{
		private static readonly Dictionary<BaseCreature, Mobile> m_BeingTamed = new Dictionary<BaseCreature, Mobile>();
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget(Mobile from)
				: base(from.EraAOS ? 3 : 2, false, TargetFlags.None)
			{ }
			...
			private void ResetPacify(BaseCreature creature)
			{
				creature.BardPacified = true;
				creature.BardEndTime = DateTime.UtcNow + TimeSpan.FromSeconds(30.0);
			}
