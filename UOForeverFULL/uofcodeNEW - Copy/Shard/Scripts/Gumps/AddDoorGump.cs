	...
	public class AddDoorGump : Gump
	{
		...
		public AddDoorGump( int type ) : base( 50, 40 )
		{
			...
			if ( m_Type >= 0 && m_Type < m_Types.Length )
			{
				...
				AddButton( 116, 37, 0x5785, 0x5785, 6, GumpButtonType.Reply, 0 );
				AddItem( 65, 45, baseID + 8 );
				AddButton( 96, 57, 0x5784, 0x5784, 5, GumpButtonType.Reply, 0 );

				AddItem( 168, 24, baseID + 4 );
				AddButton( 184, 27, 0x5780, 0x5780, 3, GumpButtonType.Reply, 0 );
				AddItem( 190, 45, baseID + 6 );
				AddButton( 201, 42, 0x5781, 0x5781, 4, GumpButtonType.Reply, 0 );

				AddItem( 230, 25, baseID + 14 );
				AddButton( 241, 27, 0x5787, 0x5787, 8, GumpButtonType.Reply, 0 );
				AddItem( 208, 45, baseID + 12 );
				AddButton( 227, 42, 0x5786, 0x5786, 7, GumpButtonType.Reply, 0 );

				AddButton( 145, 50, 0x2716, 0x2716, 9, GumpButtonType.Reply, 0 );
			}
			else
			{
				AddBlueBack( 950, 145 );
