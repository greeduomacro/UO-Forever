...
namespace Server.Gumps
{
	public class PropertiesGump : Gump
	{
			...
			switch ( info.ButtonID )
			{
				...
				default:
				{
					...
					if ( index >= 0 && index < m_List.Count )
					{
						...
						else if ( IsType( type, typeofString ) || IsType( type, typeofChar ) || IsType( type, typeofReal ) || IsType( type, typeofNumeric ) || IsType( type, typeofText ) )
		...
		public static object GetObjectFromString( Type t, string s )
		{
			...
			else if ( t == typeof( char ) || t == typeof( byte ) || t == typeof( sbyte ) || t == typeof( short ) || t == typeof( ushort ) || t == typeof( int ) || t == typeof( uint ) || t == typeof( long ) || t == typeof( ulong ) )
			{
				if ( s.StartsWith( "0x" ) )
				{
