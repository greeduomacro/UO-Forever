...
namespace Server.Gumps
{
	...
	public class PlayerVendorOwnerGump : Gump
	{
			...
			: base(50, 200)
		{
			...
			AddHtml(40, 72, 260, 20, m_Vendor.TypeOfCurrency.Name + " held for you:", false, false);
			AddLabel(300, 72, 0, m_Vendor.HoldCurrency.ToString("#,0"));

			AddHtml(40, 96, 260, 20, m_Vendor.TypeOfCurrency.Name + " held in my account:", false, false);
			AddLabel(300, 96, 0, m_Vendor.BankAccount.ToString("#,0"));

			AddHtml(40, 120, 260, 20, "My charge per day is:", false, false);
			AddLabel(300, 120, 0, perDay.ToString("#,0"));

			double days = (m_Vendor.HoldCurrency + m_Vendor.BankAccount) / ((double)perDay);

			AddHtmlLocalized(40, 25, 260, 20, 1038318, false, false); // Amount of days I can work:
			AddLabel(300, 25, 0, ((int)days).ToString("#,0"));

			AddHtmlLocalized(40, 48, 260, 20, 1038319, false, false); // Earth days:
			AddLabel(300, 48, 0, ((int)(days / 12.0)).ToString("#,0"));
		}
	...
	public class PlayerVendorCustomizeGump : Gump
	{
		...
		private class CustomItem
		{
			...
			public int LocNumber { get; private set; }
			public int ArtNumber { get; private set; }
			public bool LongText { get; private set; }

			public CustomItem(int itemID, int loc)
				: this(null, itemID, loc)
			{ }

			public CustomItem(int itemID, int loc, bool longText = false)
				: this(null, itemID, loc, 0, longText)
			{ }

			public CustomItem(Type type, int loc, int art = 0)
				: this(type, 0, loc, art)
			{ }

			public CustomItem(Type type, int itemID, int loc, int art = 0, bool longText = false)
			{
				Type = type;
				ItemID = itemID;
				LocNumber = loc;
			...
			public Item Create()
			{
				return Type != null ? Type.CreateInstanceSafe<Item>() : null;
			}
		}

		private class CustomCategory
		{
			public bool CanDye { get; private set; }
			public CustomItem[] Entries { get; private set; }
		...
		private static readonly CustomCategory[] Categories = new[]
		{
			new CustomCategory(
				Layer.InnerTorso,
				1011357,
				...
				{
					// Upper Torso
					new CustomItem(typeof(Shirt), 1011359, 5399), new CustomItem(typeof(FancyShirt), 1011360, 7933),
					new CustomItem(typeof(PlainDress), 1011363, 7937), new CustomItem(typeof(FancyDress), 1011364, 7935),
			...
			new CustomCategory(
				...
				{
					//Over chest
					new CustomItem(typeof(Doublet), 1011358, 8059), new CustomItem(typeof(Tunic), 1011361, 8097),
					new CustomItem(typeof(JesterSuit), 1011366, 8095), new CustomItem(typeof(BodySash), 1011372, 5441),
					new CustomItem(typeof(Surcoat), 1011362, 8189), new CustomItem(typeof(HalfApron), 1011373, 5435),
			...
			new CustomCategory(
				...
				{
					//Footwear
					new CustomItem(typeof(Sandals), 1011389, 5901), new CustomItem(typeof(Shoes), 1011390, 5904),
					new CustomItem(typeof(Boots), 1011391, 5899), new CustomItem(typeof(ThighBoots), 1011392, 5906)
				}),
			new CustomCategory(
				Layer.Helm,
				1011375,
				...
				{
					//Hats
					new CustomItem(typeof(SkullCap), 1011376, 5444), new CustomItem(typeof(Bandana), 1011377, 5440),
					new CustomItem(typeof(FloppyHat), 1011378, 5907), new CustomItem(typeof(WideBrimHat), 1011379, 5908),
					new CustomItem(typeof(Cap), 1011380, 5909), new CustomItem(typeof(TallStrawHat), 1011382, 5910)
				}),
			new CustomCategory(
				Layer.Helm,
				1015319,
				...
				{
					//More Hats
					new CustomItem(typeof(StrawHat), 1011382, 5911), new CustomItem(typeof(WizardsHat), 1011383, 5912),
					new CustomItem(typeof(Bonnet), 1011384, 5913), new CustomItem(typeof(FeatheredHat), 1011385, 5914),
					new CustomItem(typeof(TricorneHat), 1011386, 5915), new CustomItem(typeof(JesterHat), 1011387, 5916)
				}),
			new CustomCategory(
				Layer.Pants,
				1011367,
				...
				{
					//Lower Torso
					new CustomItem(typeof(LongPants), 1011368, 5433), new CustomItem(typeof(Kilt), 1011369, 5431),
			...
			new CustomCategory(
				...
				{
					// Hair
					new CustomItem(0x203B, 1011052), new CustomItem(0x203C, 1011053), new CustomItem(0x203D, 1011054),
					new CustomItem(0x2044, 1011055), new CustomItem(0x2045, 1011047), new CustomItem(0x204A, 1011050),
					new CustomItem(0x2047, 1011396), new CustomItem(0x2048, 1011048), new CustomItem(0x2049, 1011049)
				}),
			new CustomCategory(
				Layer.FacialHair,
				1015320,
				...
				{
					//Facial Hair
					new CustomItem(0x2041, 1011062), new CustomItem(0x203F, 1011060), new CustomItem(0x204B, 1015321, true),
					new CustomItem(0x203E, 1011061), new CustomItem(0x204C, 1015322, true), new CustomItem(0x2040, 1015323),
			...
			new CustomCategory(
				...
				{
					//Held items
					new CustomItem(typeof(FishingPole), 1011406, 3520), new CustomItem(typeof(Pickaxe), 1011407, 3717),
					new CustomItem(typeof(Pitchfork), 1011408, 3720), new CustomItem(typeof(Cleaver), 1015324, 3778),
					new CustomItem(typeof(Mace), 1011409, 3933), new CustomItem(typeof(Torch), 1011410, 3940),
					new CustomItem(typeof(Hammer), 1011411, 4020), new CustomItem(typeof(Longsword), 1011412, 3936),
			...
			new CustomCategory(
				...
				{
					//More held items
					new CustomItem(typeof(Crossbow), 1011414, 3920), new CustomItem(typeof(WarMace), 1011415, 5126),
					new CustomItem(typeof(TwoHandedAxe), 1011416, 5186), new CustomItem(typeof(Spear), 1011417, 3939),
					new CustomItem(typeof(Katana), 1011418, 5118), new CustomItem(typeof(Spellbook), 1011419, 3834)
				})
		};
	...
	public class NewPlayerVendorCustomizeGump : Gump
	{
		...
		private static readonly HairOrBeard[] m_HairStyles = new[]
		{
		...
		private static readonly HairOrBeard[] m_BeardStyles = new[]
		{
