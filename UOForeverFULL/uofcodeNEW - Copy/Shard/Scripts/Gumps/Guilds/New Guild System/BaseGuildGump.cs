...
namespace Server.Guilds
{
	public abstract class BaseGuildGump : Gump
	{
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if( pm == null || pm.Deleted || guild == null || !IsMember( pm, guild ) )
				return;
		...
		{
			return m != null && g != null && !( m.Deleted || g.Disbanded || !( m is PlayerMobile ) || (m.AccessLevel < AccessLevel.GameMaster && !g.IsMember( m )) );
		}
