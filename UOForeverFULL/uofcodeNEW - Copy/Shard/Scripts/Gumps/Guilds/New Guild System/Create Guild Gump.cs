...
namespace Server.Guilds
{
	public class CreateGuildGump : Gump
	{
			...
			: base(10, 10)
		{
			...
			// As you are not a member of any guild, you can create your own 
			// by providing a unique guild name and paying the standard guild registration fee.
			AddHtmlLocalized(25, 60, 450, 60, 1062940, 0x0, false, false);

			AddHtmlLocalized(25, 135, 120, 25, 1062941, 0x0, false, false); // Registration Fee:
			AddLabel(155, 135, 0x481, Guild.RegistrationFee.ToString("#,0"));
