...
namespace Server.Guilds
{
	public class WarDeclarationGump : BaseGuildGump
	{
		...
		public WarDeclarationGump( PlayerMobile pm, Guild g, Guild otherGuild ) : base( pm, g )
		{
            ...
            AddBackground(0, 0, 500, 370, 0x24AE);
            ...
            AddHtml(65, 90, 470, 20, "<u>NOTE:</u> Keep both conditions at 0 to wage a never-ending war.", false, false);
            AddHtmlLocalized(65, 125, 200, 20, 1063009, 0x14AF, false, false); // <i>Duration of War</i>
            AddHtmlLocalized(65, 150, 400, 20, 1063010, 0x0, false, false); // Enter the number of hours the war will last.
            AddBackground(65, 180, 40, 30, 0x2486);
            AddTextEntry(70, 184, 50, 30, 0x481, 10, (war != null) ? war.WarLength.Hours.ToString() : "0");
            AddHtmlLocalized(65, 225, 200, 20, 1063011, 0x14AF, false, false); // <i>Victory Condition</i>
            AddHtmlLocalized(65, 250, 400, 20, 1063012, 0x0, false, false); // Enter the winning number of kills.
            AddBackground(65, 280, 40, 30, 0x2486);
            AddTextEntry(70, 284, 50, 30, 0x481, 11, (war != null) ? war.MaxKills.ToString() : "0");
            AddBackground(190, 300, 130, 26, 0x2486);
            AddButton(195, 305, 0x845, 0x846, 0, GumpButtonType.Reply, 0);
            AddHtmlLocalized(220, 303, 90, 26, 1006045, 0x0, false, false); // Cancel
            AddBackground(330, 300, 130, 26, 0x2486);
            AddButton(335, 305, 0x845, 0x846, 1, GumpButtonType.Reply, 0);
            AddHtmlLocalized(360, 303, 90, 26, 1062989, 0x5000, false, false); // Declare War!
			...
			AddHtmlLocalized( 75, 55, 370, 26, 1062979, 0x3C00, false, false ); // <div align=center><i>Declaration of War</i></div>
			AddImage( 410, 45, 0x232C );
            //AddHtml(65, 90, 200, 20, "Just keep both conditions at 0 to wage a never-ending war.", false, false);
