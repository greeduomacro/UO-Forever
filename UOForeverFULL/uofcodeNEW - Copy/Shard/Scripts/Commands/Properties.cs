...
namespace Server.Commands
{
	...
	public class Properties
	{
		...
		{
			CommandSystem.Register( "Props", AccessLevel.GameMaster, new CommandEventHandler( Props_OnCommand ) );
		}
		...
		public static string IncreaseValue( Mobile from, object o, string[] args )
		{
			...
			for ( int i = 0; i < realProps.Length; ++i )
			{
				...
				try
				{
					...
					EventSink.InvokeOnPropertyChanged(new OnPropertyChangedEventArgs(from, realObjs[i], realProps[i], obj, v));
				}
				catch
				{
