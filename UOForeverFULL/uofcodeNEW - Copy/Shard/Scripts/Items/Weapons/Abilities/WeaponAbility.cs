...
namespace Server.Items
{
	public abstract class WeaponAbility
	{
		...
		public virtual bool CheckWeaponSkill( Mobile from )
		{
			...
			bool reqTactics = weapon.EraML && RequiresTactics( from );

			if ( from.EraML && reqTactics && from.Skills[SkillName.Tactics].Base < reqSkill )
			{
		...
		private static WeaponAbility[] m_Abilities = new WeaponAbility[31]
			{
				...
				new ParalyzingBlow(),
				new ShadowStrike(),
				null, //new WhirlwindAttack(),

				null, // new RidingSwipe(),
				null, //new FrenziedWhirlwind(),
				null, //new Block(),
				null, //new DefenseMastery(),
				null, // new NerveStrike(),
				null, //new TalonStrike(),
				null, //new Feint(),
				null, //new DualWield(),
				null, //new DoubleShot(),
				null, //new ArmorPierce(),
				null,
				null,
				null,
				null,
