...
namespace Server.Items
{
	public class SlayerEntry
	{
		...
		public SlayerName Name { get; private set; }
		public Type[] Types { get; private set; }

		private static readonly int[] m_AosTitles = new[] {//
		...
		private static readonly int[] m_OldTitles = new[] {//
			1017384, // Silver
			1017385, // Orc Slaying
		...
		public int GetTitle(bool aos)
		{
			int[] titles = aos ? m_AosTitles : m_OldTitles;
