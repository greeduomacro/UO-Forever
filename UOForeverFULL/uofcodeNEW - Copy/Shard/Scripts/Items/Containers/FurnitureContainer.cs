...
namespace Server.Items
{
	...
	public class OrnateElvenBox : BaseContainer
	{
		[Constructable]
	...
	public class DynamicFurniture
	{
		...
		public static bool Open( Container c, Mobile m )
		{
			...
			if ( c is Armoire || c is FancyArmoire || c is DonationChest)
			{
				...
				switch ( c.ItemID )
				{
                    ...
                    case 0x4102: c.ItemID = 0x4105; break;
				}
			}
		...
		public static void Close( Container c )
		{
			...
			if ( c is Armoire || c is FancyArmoire || c is DonationChest)
			{
				switch ( c.ItemID )
				{
                    ...
                    case 0x4105: c.ItemID = 0x4102; break;
				}
			}
		}
	}
