...
namespace Server.Items
{
    public class Aquarium : BaseAddonContainer
    {
        ...
        public int DeadCreatures
        {
            get
            {
                return Items.OfType<BaseFish>().Count(fish => fish.Dead);
            }
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            else if (dropped is VacationWafer)
            {
                ...
                from.SendLocalizedMessage(1074428, m_VacationLeft.ToString(CultureInfo.InvariantCulture));
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            if (m_VacationLeft > 0)
                list.Add(1074430, m_VacationLeft.ToString(CultureInfo.InvariantCulture)); // Vacation days left: ~1_DAYS

            if (m_Events.Count > 0)
                list.Add(1074426, m_Events.Count.ToString(CultureInfo.InvariantCulture)); // ~1_NUM~ event(s) to view!
            ...
            if (dead > 0)
                list.Add(1074248, dead.ToString(CultureInfo.InvariantCulture)); // Dead Creatures: ~1_NUM~

            int decorations = Items.Count - m_LiveCreatures - dead;

            if (decorations > 0)
                list.Add(1074249, decorations.ToString(CultureInfo.InvariantCulture)); // Decorations: ~1_NUM~
            ...
            if (m_Food.State == (int) FoodState.Dead)
                ...
                list.Add(1074253, "{0}\t{1}\t{2}", m_Food.Added, m_Food.Maintain, m_Food.Improve);
            ...
            if (m_Water.State == (int) WaterState.Dead)
                ...
                list.Add(1074254, "{0}\t{1}\t{2}", m_Water.Added, m_Water.Maintain, m_Water.Improve);
        ...
        {
            m_LiveCreatures = 0;
            var fish = FindItemsByType<BaseFish>();
        ...
        {
            var toKill = Items.OfType<BaseFish>().Where(fish => !fish.Dead).ToList();
        ...
        public virtual void GiveReward(Mobile to)
        {
            ...
            {
                item.Delete();
                to.SendLocalizedMessage(1074361);
                    // The reward could not be given.  Make sure you have room in your pack.
                return;
            }

            to.SendLocalizedMessage(1074360, String.Format("#{0}", item.LabelNumber));
                // You receive a reward: ~1_REWARD~
            to.PlaySound(0x5A3);
        ...
        public virtual bool AddFish(Mobile from, BaseFish fish)
        {
            ...
            if (from != null)
                from.SendLocalizedMessage(1073632, String.Format("#{0}", fish.LabelNumber));
        ...
        public virtual bool AddDecoration(Mobile from, Item item)
        {
            ...
            if (from != null)
                from.SendLocalizedMessage(1073635,
                    (item.LabelNumber != 0) ? String.Format("#{0}", item.LabelNumber) : item.Name);
        ...
        public static FishBowl GetEmptyBowl(Mobile from)
        {
            ...
            return items.OfType<FishBowl>().FirstOrDefault(bowl => bowl.Empty);
        }
        ...
        public static bool Accepts(Item item)
        {
            ...
            return m_Decorations.Any(t => type == t);
        }
    ...
    public class AquariumEastDeed : BaseAddonContainerDeed
    {
        ...
        {
            get { return new Aquarium(0x3062); }
        }
    ...
    public class AquariumNorthDeed : BaseAddonContainerDeed
    {
        public override BaseAddonContainer Addon
        {
            get { return new Aquarium(0x3060); }
        }
