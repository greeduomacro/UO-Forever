...
namespace Server.Items
{
    ...
    // ********** RawHumanFlesh **********
    public class RawHumanBrain : CookableFood
    {
        private Mobile Owner;
        [Constructable]
        public RawHumanBrain()
            : this(1)
        {
        }

        [Constructable]
        public RawHumanBrain(int amount, Mobile owner)
            : base(0x1CF0, 90)
        {
            if (owner != null)
                Name = "the brain of " + owner.Name;
            else
            {
                Name = "a brain";
            }
        ...
        public RawHumanBrain(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            return new CookedHumanBrain(1, Owner);
        }
    }

    // ********** RawHumanFlesh **********
    public class RawHumanFlesh : CookableFood
    {
        private Mobile Owner;
        [Constructable]
        public RawHumanFlesh()
            : this(1)
        {
        }

        [Constructable]
        public RawHumanFlesh(int amount, Mobile owner)
            : base(0x979, 75)
        {
            Name = "raw human flesh";
            Owner = owner;
            Weight = 1.0;
            Stackable = true;
            Amount = amount;
        ...
        public RawHumanFlesh(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            if (Owner != null)
                LabelTo(from, "The bloody remains of " + Owner.Name + ".", 33);
        }

        public override bool CanStackWith(Item dropped)
        {
            var flesh = dropped as RawHumanFlesh;
