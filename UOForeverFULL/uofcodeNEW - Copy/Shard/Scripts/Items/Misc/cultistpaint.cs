...
{
	[TypeAlias("Server.Items.cultistpaint")]
	public class CultistPaint : Item
	{
		[Constructable]
		public CultistPaint()
			: base(0x9EC)
		{
			Name = "cultist body paint";
			Hue = 1154;
			Weight = 2.0;
			Stackable = false;
		}

		public CultistPaint(Serial serial)
			: base(serial)
		{ }
		...
		public override void OnDoubleClick(Mobile from)
		{
			if (IsChildOf(from.Backpack))
			{
				...
				else
				{
					...
					from.SendMessage("You know bear the markings of a Khaldun cultist.");
