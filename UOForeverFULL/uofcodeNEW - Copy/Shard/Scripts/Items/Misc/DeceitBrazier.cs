		...
		private static Type[] m_Creatures = new Type[]
			{
				...
				typeof( BoneKnight ), 		typeof( Lich ), 				typeof( LichLord ), 			typeof( BoneMage ),
				typeof( Wraith ), 			typeof( Shade ), 				typeof( Spectre ), 				typeof( Zombie ),
				typeof( RottingCorpse ),	typeof( Ghoul ),				typeof( DarkSkeletalKnight ),	typeof( DarkSkeleton ),
				typeof( DarkSkeletalMage ),
				#endregion
				...
				typeof( BurningImp ),			typeof( NetherImp ),
				#endregion
				...
				typeof( AirElemental ),		typeof( GreaterPoisonElemental ),	typeof( GreaterBloodElemental ),
				typeof( AcidElemental ),	typeof( PyroclasticElemental ),	typeof( MagmaElemental ),	//typeof( Golem ),
				#endregion

				#region Hunters
				typeof( SlimeHunter ),		typeof( DragonHunter ),			typeof( DemonHunter ),			typeof( SpiritHunter ),
				typeof( TrollHunter ),		typeof( ElementalHunter ),		typeof( OrcHunter ),			typeof( BoneHunter ),
				#endregion
