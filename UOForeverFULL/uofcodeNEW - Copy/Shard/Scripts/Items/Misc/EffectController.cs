...
namespace Server.Items
{
	...
	public class EffectController : Item
	{
		...
		public FlashType FlashType{ get{ return m_FlashType; } set{ m_FlashType = value; } }
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.WriteEncodedInt( (int)m_FlashType );
...
*/
		...
		public void PlaySound( IEntity ent )
		{
		...
		public void DoEffect( IEntity trigger )
		{
			...
			if ( m_SoundID > 0 )
				Timer.DelayCall<IEntity>( m_SoundDelay, new TimerStateCallback<IEntity>( PlaySound ), m_PlaySoundAtTrigger ? trigger : this );
