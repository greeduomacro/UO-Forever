...
namespace Server.Items
{
	public abstract class PromotionalToken : Item
	{
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1070998, ItemName != null ? ItemName.ToString() : "item" ); // Use this to redeem<br>your ~1_PROMO~
		}
	...
	public class SoulstoneToken : PromotionalToken
	{
		...
		public override TextDefinition ItemName { get { return 1030902; } }//soulstone
