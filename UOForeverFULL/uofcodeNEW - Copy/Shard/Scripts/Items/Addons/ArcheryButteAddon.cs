...
namespace Server.Items
{
	...
	public class ArcheryButteAddon : BaseAddon
	{
		...
		[Constructable]
		public ArcheryButteAddon( bool facingeast )
		{
			AddComponent( new ArcheryButte( facingeast ? 0x100A : 0x100B ), 0, 0, 0 );
		}
	...
	{
		public override BaseAddon Addon{ get{ return new ArcheryButteAddon( true ); } }
