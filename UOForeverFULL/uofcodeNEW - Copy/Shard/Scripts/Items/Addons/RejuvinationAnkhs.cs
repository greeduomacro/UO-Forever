	...
	public class RejuvinationAddonComponent : AddonComponent
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( from.BeginAction( typeof( RejuvinationAddonComponent ) ) )
			{
				...
				Timer.DelayCall<object[]>( TimeSpan.FromHours( 2.0 ), new TimerStateCallback<object[]>( ReleaseUseLock_Callback ), new object[]{ from, random } );
			}
		}

		public virtual void ReleaseUseLock_Callback( object[] states )
		{
