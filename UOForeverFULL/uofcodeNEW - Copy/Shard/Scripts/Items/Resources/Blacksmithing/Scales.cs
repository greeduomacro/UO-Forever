...
//		public override int LabelNumber{ get{ return 1053140; } } // sea serpent scales
	...
	public class BloodScales : BaseScales
	{
		public override string DefaultName{ get{ return "blood scales"; } }

		[Constructable]
		public BloodScales() : this( 1 )
		{
		}

		[Constructable]
		public BloodScales( int amount ) : base( CraftResource.BloodScales, amount )
		{
		}

		public BloodScales( Serial serial ) : base( serial )
		{
		}
