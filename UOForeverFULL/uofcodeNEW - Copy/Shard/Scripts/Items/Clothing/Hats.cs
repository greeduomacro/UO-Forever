...
namespace Server.Items
{
	public abstract class BaseHat : BaseClothing, IShipwreckedItem
	{
		...
		public bool IsShipwreckedItem { get { return m_IsShipwreckedItem; } set { m_IsShipwreckedItem = value; } }
		...
		{
			bool ismagical = base.AddEquipInfoAttributes(from, attrs);
	...
	{
		public override int InitMinHits { get { return (EraML ? 14 : 7); } }
		public override int InitMaxHits { get { return (EraML ? 28 : 12); } }
	...
	public class OrcishKinMask : BaseHat
	{
		...
		public override string DefaultName { get { return "a mask of orcish kin"; } }
	...
	public class OrcishKinRPMask : BaseHat
	{
		...
		[Constructable]
		public OrcishKinRPMask()
			: this(2212)
		{ }

		[Constructable]
		public OrcishKinRPMask(int hue)
			: base(0x141B, hue)
		{
			Weight = 1.0;
		...
		public OrcishKinRPMask(Serial serial)
			: base(serial)
		{ }
    ...
    public class OrcishKinMaskGV : BaseHat
    {
        public override bool Dye(Mobile from, IDyeTub sender)
        {
            from.SendLocalizedMessage(sender.FailMessage);
        ...
        [Constructable]
        public OrcishKinMaskGV()
            : this(2212)
        { }

        [Constructable]
        public OrcishKinMaskGV(int hue)
            : base(0x141B, hue)
        {
            Weight = 1.0;
            Name = "a mask of orcish kin";
        ...
        public OrcishKinMaskGV(Serial serial)
            : base(serial)
        { }
