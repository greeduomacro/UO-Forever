...
namespace Server.Items
{
    ...
    public class TaxidermyKit : Item
    {
        ...
        private class CorpseTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                {
                    from.SendLocalizedMessage(1042596);
    ...
    public class TrophyAddon : Item, IAddon
    {
        ...
        {
			get { return ObjectPropertyList.Enabled && EraAOS; }
        }
        ...
        public TrophyAddon(Mobile from, int itemID, int westID, int northID, int deedNumber, int addonNumber,
            Mobile hunter, int animalWeight)
            : base(itemID)
        {
            m_WestID = westID;
            m_NorthID = northID;
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            if (m_AnimalWeight >= 20)
            {
                ...
                list.Add(1070858, m_AnimalWeight.ToString(CultureInfo.InvariantCulture)); // ~1_weight~ stones
            }
        }
