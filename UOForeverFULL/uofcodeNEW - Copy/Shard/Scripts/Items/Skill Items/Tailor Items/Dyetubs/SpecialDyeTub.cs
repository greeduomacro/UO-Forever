...
namespace Server.Items
{
	public class SpecialDyeTub : DyeTub, IRewardItem
	{
		...
		[Constructable]
		public SpecialDyeTub() : this( 0 )
		{
		}

		[Constructable]
		public SpecialDyeTub( int hue ) : this( hue, true )
		{
		}

		[Constructable]
		public SpecialDyeTub( int hue, bool redyable ) : this( hue, true, -1 )
		{
		}

		[Constructable]
		public SpecialDyeTub( int hue, bool redyable, int uses ) : base( hue, redyable, uses )
		{
