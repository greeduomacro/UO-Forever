            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                if (targeted is DyeTub)
                {
                    ...
                    if (tub.Redyable)
                    {
                        ...
                        {
                            from.SendGump(new MetallicHuePicker(from,
                                new MetallicHuePicker.MetallicHuePickerCallback(SetTubHue), tub));
                        }
                        else*/ if (tub.CustomHuePicker != null)
                        {
                            from.SendGump(new CustomHuePickerGump(from, tub.CustomHuePicker,
                                new CustomHuePickerCallback(SetTubHue), tub));
                        }
                        else
                        {
