...
//		public void ApplyAttributesTo( BaseWeapon weapon )
		public static void ApplyAttributesTo( BaseWeapon weapon, CraftResource resource )
		{
        ...
        /*
		public static void ApplyAttributesTo( BaseArmor armor, CraftResource resource )
		{
			CraftResourceInfo resInfo = CraftResources.GetInfo( resource );
