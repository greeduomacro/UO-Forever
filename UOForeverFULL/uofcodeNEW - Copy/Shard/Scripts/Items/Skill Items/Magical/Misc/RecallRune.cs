...
namespace Server.Items
{
	...
	public class RecallRune : Item
	{
        ...
        public override Type DyeType { get { return typeof(RuneDyeTub); } }
        public override bool DisplayDyable { get { return true; } }
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if (m_Marked)
			{
				...
				{
					list.Add((House != null ? 1063260 : 1063259), RuneFormat, desc);
				}
		...
		public override void OnSingleClick(Mobile from)
		{
			...
			if (m_Marked)
			{
				...
				if (m_TargetMap == Map.Tokuno)
				{
					LabelTo(from, (House != null ? 1063260 : 1063259), String.Format(RuneFormat, desc));
				}
					// ~1_val~ (Tokuno Islands)[(House)]
				else if (m_TargetMap == Map.Malas)
				{
					LabelTo(from, (House != null ? 1062454 : 1060804), String.Format(RuneFormat, desc));
				}
					// ~1_val~ (Malas)[(House)]
				else if (m_TargetMap == Map.Felucca)
				{
					LabelTo(from, (House != null ? 1062452 : 1060805), String.Format(RuneFormat, desc));
				}
					// ~1_val~ (Felucca)[(House)]
				else if (m_TargetMap == Map.Trammel)
				{
					LabelTo(from, (House != null ? 1062453 : 1060806), String.Format(RuneFormat, desc));
				}
					// ~1_val~ (Trammel)[(House)]
				else
				{
