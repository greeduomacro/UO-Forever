...
namespace Server.Items
{
	...
	public class Spellbook : Item, ICraftable, ISlayer, IEthicsItem
	{
		...
		public override DeathMoveResult OnParentDeath(Mobile parent)
		{
			...
			if (result == DeathMoveResult.MoveToCorpse && m_EthicState != null)
			{
		...
		public static List<Spellbook> FindAllSpellbooks(Mobile from)
		{
			...
			var item = from.FindItemOnLayer(Layer.OneHanded) as Spellbook;
		...
		public override Type DyeType { get { return typeof(SpellbookDyeTub); } }
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if (EraML && (prop = m_AosAttributes.IncreasedKarmaLoss) != 0)
			{
