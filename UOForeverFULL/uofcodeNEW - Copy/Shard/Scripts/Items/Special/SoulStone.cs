...
namespace Server.Items
{
	public class SoulStone : Item, ISecurable
	{
		...
		public static readonly TimeSpan UseDelay = TimeSpan.FromMinutes( 10.0 );
		...
		protected class SelectSkillGump : Gump
		{
		...
		protected class ConfirmSkillGump : Gump
		{
			private SoulStone m_Stone;
		...
		protected class ConfirmTransferGump : Gump
		{
			private SoulStone m_Stone;
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				m_Stone.NextUse = DateTime.UtcNow + UseDelay;
		...
		protected class ConfirmRemovalGump : Gump
		{
			private SoulStone m_Stone;
		...
		protected class ErrorGump : Gump
		{
			private SoulStone m_Stone;
