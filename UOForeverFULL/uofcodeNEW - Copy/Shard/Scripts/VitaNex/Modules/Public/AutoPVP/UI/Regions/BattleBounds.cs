...
namespace VitaNex.Modules.AutoPvP
{
	public class PvPBattleBoundsGump : Rect3DListGump
	{
		...
		public override void DisplayPreview()
		{
			...
			if (!Preview || InputMap == null || InputMap == Map.Internal || Battle.SpectateRegion == null || Battle.SpectateRegion.Area.Length == 0)
			{
				if (_SpectatePreview != null)
				{
					_SpectatePreview.Unregister();
			...
			if (_SpectatePreview != null)
			{
				if (_SpectatePreview.Map == InputMap && _SpectatePreview.Area.GetBoundsHashCode() == Battle.SpectateRegion.Area.GetBoundsHashCode())
				{
