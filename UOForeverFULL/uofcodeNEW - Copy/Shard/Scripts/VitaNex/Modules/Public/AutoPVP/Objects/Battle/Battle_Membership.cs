...
namespace VitaNex.Modules.AutoPvP
{
	public abstract partial class PvPBattle
	{
		...
		{
			if (m == null || m.Deleted || State == PvPBattleState.Internal)
			{
				return;
			}
		...
		{
			if (player == null || player.Deleted || player.Region == null || State == PvPBattleState.Internal)
			{
				return;
			}
		...
		{
			if (creature == null || creature.Deleted || creature.Region == null || State == PvPBattleState.Internal)
			{
				return;
			}
		...
		{
			if (pet == null || pet.Deleted || pet.Region == null || State == PvPBattleState.Internal)
			{
				return;
			}
