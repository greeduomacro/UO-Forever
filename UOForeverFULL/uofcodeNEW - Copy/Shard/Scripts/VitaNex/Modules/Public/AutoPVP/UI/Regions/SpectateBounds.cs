...
namespace VitaNex.Modules.AutoPvP
{
	public class PvPSpectateBoundsGump : Rect3DListGump
	{
		...
		public override void DisplayPreview()
		{
			...
			if (!Preview || InputMap == null || InputMap == Map.Internal || Battle.BattleRegion == null || Battle.BattleRegion.Area.Length == 0)
			{
				if (_BattlePreview != null)
				{
					_BattlePreview.Unregister();
			...
			if (_BattlePreview != null)
			{
				if (_BattlePreview.Map == InputMap && _BattlePreview.Area.GetBoundsHashCode() == Battle.BattleRegion.Area.GetBoundsHashCode())
				{
