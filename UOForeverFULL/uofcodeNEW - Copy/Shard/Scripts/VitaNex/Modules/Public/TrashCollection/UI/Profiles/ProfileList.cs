...
namespace VitaNex.Modules.TrashCollection
{
	...
	{
		public TrashCollectionProfilesGump(
			PlayerMobile user, Gump parent = null, bool useConfirm = true, bool sortByToday = false)
		...
		protected override void CompileEntryLayout(
			SuperGumpLayout layout, int length, int index, int pIndex, int yOffset, TrashProfile entry)
		{
