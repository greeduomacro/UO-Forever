...
namespace VitaNex.Modules.TrashCollection
{
	public sealed class TrashCollectionOptions : CoreModuleOptions
	{
		...
		public string AdminCommand { get { return _AdminCommand; } set { CommandUtility.Replace(_AdminCommand, TrashCollection.Access, HandleAdminCommand, (_AdminCommand = value)); } }
