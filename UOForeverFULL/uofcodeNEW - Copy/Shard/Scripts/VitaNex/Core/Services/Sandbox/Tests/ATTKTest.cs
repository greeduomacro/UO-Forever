...
namespace VitaNex.Sandbox.Tests
{
	public sealed class ATTKTest : ISandboxTest
	{
		private static readonly string[] _Vars = new[]
		{
			...
			"paint epic scenes", "pee vee pee", "fletch arrows", "sail the seas", "clean Vorspire's shoes", "play Ultima Online",
			"collect stamps", "res kill newbs", "grow plants", "slay mighty beasts", "dance for the King", "play Skyrim",
			"be a target", "be a hero", "adventure everywhere", "sell live-tock", "beta test", "pillage and burn villages",
			"drink every day", "fly high", "be good in bed", "satisfy your partner", "stare into space", "stare at pixels",
			"loot houses", "gank newbs", "jump around", "laugh out loud", "love April Fools Day", "have a knee", "say 'used to'",
			"go Faith Hilling", "tramp spotting", "kill stealing", "gamble a lot", "bench 200 pounds", "be a millionairre",
			"come early", "say random things"
		};
