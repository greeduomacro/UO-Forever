	...
	public class FirePentagramEffect : BaseSpecialEffect
	{
		public static EffectInfo[] Info
		{
			get
			{
				return new[]
				{
					new EffectInfo(null, null, 14089, 1357, 10, 20, EffectRender.SemiTransparent),
					new EffectInfo(null, null, 13401, 1357, 10, 20, EffectRender.Normal, TimeSpan.FromMilliseconds(200))
				};
			}
		}
