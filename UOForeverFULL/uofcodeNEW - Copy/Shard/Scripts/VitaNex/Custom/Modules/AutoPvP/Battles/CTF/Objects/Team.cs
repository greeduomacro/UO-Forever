...
{
	public class UOF_CTFTeam : UOF_PvPTeam
	{
		private static readonly TimeSpan _OneSecond = TimeSpan.FromSeconds(1.0);

		private UOF_CTFPodium _FlagPodium;
		...
		public UOF_CTFBattle CTFBattle { get { return Battle as UOF_CTFBattle; } }

		[CommandProperty(AutoPvP.Access, true)]
		public UOF_CTFFlag Flag { get; private set; }
		...
		[CommandProperty(AutoPvP.Access)]
		public virtual UOF_CTFPodium FlagPodium
		{
		...
		public UOF_CTFTeam(PvPBattle battle, GenericReader reader)
			: base(battle, reader)
		{ }
		...
		public virtual void InvalidateFlagPodium()
		{
			...
			{
				FlagPodium = new UOF_CTFPodium(this);
			}
			else
			{
		...
		public override void OnMemberRemoved(PlayerMobile pm)
		{
			...
			{
				Battle.Teams.OfType<UOF_CTFTeam>()
		...
		public virtual void SpawnFlag()
		{
			...
			Flag = Flag != null && !Flag.Deleted ? Flag : new UOF_CTFFlag(this);
			Flag.Carrier = null;
			Flag.Reset();
		}
		...
		public virtual void OnFlagDropped(PlayerMobile attacker, UOF_CTFTeam enemyTeam)
		{
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			switch (version)
			{
				case 0:
					{
						Flag = reader.ReadItem<UOF_CTFFlag>();
						...
						FlagPodium = reader.ReadItem<UOF_CTFPodium>();
