...
namespace VitaNex.Modules.AutoPvP.Battles
{
	public class UOF_CTFFlag : Item
	{
		...
		public UOF_CTFFlag(Serial serial)
			: base(serial)
		{ }

		public UOF_CTFTeam GetEnemyTeam(PlayerMobile attacker)
		{
			return Team.Battle.FindTeam<UOF_CTFTeam>(attacker);
		}
		...
		{
			return Carrier == null &&
				   ((Team.FlagPodium != null && this.InRange2D(Team.FlagPodium, 1)) ||
					(Team.FlagPodium == null && this.InRange2D(Team.HomeBase, 1)));
		}
