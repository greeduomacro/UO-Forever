...
{
    public class ThrowawbleFootstool: BaseThrowable<IEntity>
	{
		[Constructable]
		public ThrowawbleFootstool()
			: this(1)
		{ }

		[Constructable]
		public ThrowawbleFootstool(int amount)
			: base(2910, amount)
		{
			Name = "foot stool";
        ...
        public ThrowawbleFootstool(Serial serial)
			: base(serial)
		{ }
