...
namespace Server
{
    public class PortalScoresOverviewGump : ListGump<KeyValuePair<PlayerMobile, int>>
    {
        public Dictionary<PlayerMobile, int> PlayerScores { get; set; }

        public Portal Portal { get; set; }

        public PortalScoresOverviewGump(
            PlayerMobile user,
            Portal portal,
            Gump parent = null)
            : base(user, parent, 150, 100, emptyText: "No Scores to Display.", title: "")
        {
            PlayerScores = portal.ParticipantsScores;
            Portal = portal;
        ...
        protected override void CompileLayout(SuperGumpLayout layout)
        {
            ...
            layout.Add(
                ...
                () =>
                {
                    AddLabel(89, 63, 2049, @"Portal Scoreboard:");
                });
