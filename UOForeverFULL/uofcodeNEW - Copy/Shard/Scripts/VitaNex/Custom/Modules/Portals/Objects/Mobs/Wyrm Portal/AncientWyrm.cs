...
namespace Server.Mobiles
{
    ...
    public class AncientWyrmPortal : BaseCreature
    {
        ...
        [Constructable]
        public AncientWyrmPortal() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = 46;
            BaseSoundID = 362;
        ...
        public AncientWyrmPortal(Serial serial)
            : base(serial)
        {}
