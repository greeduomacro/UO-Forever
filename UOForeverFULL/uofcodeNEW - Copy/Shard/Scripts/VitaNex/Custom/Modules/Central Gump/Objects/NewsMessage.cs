...
{
	[PropertyObject]
	public sealed class Message : IEquatable<Message>, IComparable<Message>
	{
		public string UniqueID { get; private set; }

        [CommandProperty(CentralGump.Access)]
        ...
        public Message(GenericReader reader)
		{
			Deserialize(reader);
		}
		...
		public void Delete()
		{
			...
			CentralGump.Messages.Remove(UniqueID);
		}
