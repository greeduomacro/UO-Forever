...
namespace Server.Regions
{
	...
	public class BaseRegion : Region
	{
		...
		private Dictionary<Type, LootCollection> m_LootTable = new Dictionary<Type, LootCollection>();
		public Dictionary<Type, LootCollection> LootTable{ get{ return m_LootTable; } }
		...
		public override void OnEnter(Mobile m)
		{
			...
			{
				if(this is DungeonRegion && !this.YoungProtected)
				{
