...
namespace Server.Misc
{
	public class ServerList
	{
		...
		public static readonly string ServerName = ShardInfo.ShardListingName;
		...
		private static bool IsPrivateNetwork( IPAddress ip )
		{
			...
			return ip.AddressFamily != AddressFamily.InterNetworkV6 && (Utility.IPMatch( "192.168.*", ip ) || Utility.IPMatch( "10.*", ip ) || Utility.IPMatch( "172.16-31.*", ip ));
		}
