...
namespace Server
{
	public class AOS
	{
		...
		*/
		...
		public static int Damage(
			Mobile m, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, int chaos)
		{
		...
		/// </summary>
		public static int Damage(
			Mobile m, Mobile from, int damage, bool ignoreArmor, int phys, int fire, int cold, int pois, int nrgy)
		{
		...
		/// </summary>
		public static int Damage(
			Mobile m, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, bool keepAlive)
		{
	...
	public sealed class AosAttributes : BaseAttributes
	{
		...
		{
			return 0; // some day this insanity will all be gone!
		}
	...
	public abstract class BaseAttributes
	{
		...
		{
			if (m_Owner == null || !m_Owner.EraAOS)
			{
				return 0;
			}
