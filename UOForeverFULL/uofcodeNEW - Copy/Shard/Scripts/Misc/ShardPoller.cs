...
namespace Server.Misc
{
	public class ShardPoller : Item
	{
		...
		{
			if ( m_ActivePollers.Count == 0 || e.Mobile is BaseCreature)
				return;

			Timer.DelayCall<Mobile>( TimeSpan.FromSeconds( 1.0 ), new TimerStateCallback<Mobile>( EventSink_Login_Callback ), e.Mobile );
		}
		...
		public void SendQueuedPoll_Callback( object[] states )
		{
