...
{
	public class VeteranCloak : Cloak, IVeteranClothing, IRewardItem
	{
		...
		{
			pm.AddSkillGainMod( "VeteranSkillGainMod-Cloak", (SkillName)(-1), 0.05 * m_Level, TimeSpan.Zero );
		...
		{
			pm.RemoveSkillGainMod( "VeteranSkillGainMod-Cloak" );
		...
		public VeteranCloak( Serial serial ) : base( serial )
		{
		}
		...
		{
			if ( Parent is PlayerMobile )
				((PlayerMobile)Parent).RemoveSkillGainMod( "VeteranSkillGainMod-Cloak" );
