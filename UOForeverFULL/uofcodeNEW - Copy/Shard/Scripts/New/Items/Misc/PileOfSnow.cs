...
{
	public class PileOfSnow : Item
	{
		[Constructable]
		public PileOfSnow() : base( 0x913 )
		{
			Hue = 0x480;
			Weight = 1.0;
		}
		...
		public PileOfSnow( Serial serial ) : base( serial )
		{
		}
		...
		private class SnowTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object target )
			{
				...
				else if ( target is Mobile )
				{
					...
					if ( pack != null && pack.FindItemByType( new Type[]{ typeof( SnowPile ), typeof( PileOfSnow ) } ) != null )
					{
