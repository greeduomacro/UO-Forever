...
{
	public abstract class BaseCripplePotion : BasePotion
	{
		public abstract int Loss { get; }

		public BaseCripplePotion( PotionEffect effect ) : base( 0xE24, effect )
		{
			Hue = 1281;
		}

		public BaseCripplePotion( Serial serial ) : base( serial )
		{
		}
		...
		private class DelayTimer : Timer
		{
			...
			{
				m_Mobile.EndAction( typeof( BaseCripplePotion ) );
			}
		}
	}
}