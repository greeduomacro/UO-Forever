...
namespace Server.Items
{
	public class EmeraldDust : Item
	{
		...
		[Constructable]
		public EmeraldDust() : this( 1 )
		{
		}

		[Constructable]
		public EmeraldDust( int amount ) : base( 0x5745 )
		{
			Stackable = true;
            Hue = 78;
			Amount = amount;
        ...
        private static readonly Type[] m_Types = new Type[] { typeof(EmeraldDust), typeof(Food) };
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (IsChildOf(from.Backpack))
            {
                ...
                {
                    Consume();
                    from.AddToBackpack(new EmeraldPower());
                }
            }
        }

		public EmeraldDust( Serial serial ) : base( serial )
		{
		}
