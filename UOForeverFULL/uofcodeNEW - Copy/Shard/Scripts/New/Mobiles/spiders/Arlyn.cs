...
namespace Server.Mobiles
{
	...
	public class Arlyn : BaseCreature
	{
		public override string DefaultName{ get{ return "Arlyn"; } }

		[Constructable]
		public Arlyn() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 11;
			Hue = 0;
			BaseSoundID = 0x388;
		...
		public Arlyn( Serial serial ) : base( serial )
		{
		}
