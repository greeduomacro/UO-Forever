...
namespace Server.Mobiles
{
	...
	public class Kyrk: BaseCreature
	{
		public override string DefaultName{ get{ return "Kyrk"; } }

		[Constructable]
		public Kyrk() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 11;
			Hue = 0;
			BaseSoundID = 1170;
		...
		public Kyrk( Serial serial ) : base( serial )
		{
		}
