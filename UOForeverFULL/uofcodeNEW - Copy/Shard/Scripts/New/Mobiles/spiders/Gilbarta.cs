...
namespace Server.Mobiles
{
	...
	public class Gilbarta : BaseCreature
	{
		public override string DefaultName{ get{ return "Gilbarta"; } }

		[Constructable]
		public Gilbarta() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 173;
			Hue = 0;
			BaseSoundID = 0x388;
		...
		public Gilbarta( Serial serial ) : base( serial )
		{
		}
