...
namespace Server.Mobiles
{
	...
	public class CharleySpider : BaseCreature
	{
		public override string DefaultName{ get{ return "Charley"; } }

		[Constructable]
		public CharleySpider() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 737;
			BaseSoundID = 0x388;
		...
		public CharleySpider( Serial serial ) : base( serial )
		{
		}
