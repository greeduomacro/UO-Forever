...
{
    [CorpseName("platinum dragon corpse")]
    public class PlatinumDragon : BaseCreature
    {
        public override string DefaultName { get { return "a platinum dragon"; } }

        [Constructable]
        public PlatinumDragon() : base(AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            Body = 198;
