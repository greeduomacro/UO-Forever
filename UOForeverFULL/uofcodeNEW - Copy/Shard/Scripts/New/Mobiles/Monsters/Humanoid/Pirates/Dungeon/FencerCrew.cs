...
namespace Server.Mobiles
{
	...
	public class FencerCrew : BaseCreature
	{



		[Constructable]
		public FencerCrew() : base( AIType.AI_Archer, FightMode.Strongest, 10, 1, 0.2, 0.4 )
		{
		...
		public FencerCrew( Serial serial ) : base( serial )
		{
		}
