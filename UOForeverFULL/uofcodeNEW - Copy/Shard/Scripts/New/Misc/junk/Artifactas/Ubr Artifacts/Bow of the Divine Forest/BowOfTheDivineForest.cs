...
namespace Server.Items
{
	...
	public class BowOfTheDivineForest : BaseRanged
	{
		...
		[Constructable]
		public BowOfTheDivineForest() : base( 0x26C2 )
		{
			Name = "Bow of the Divine Forest";
			Hue = 2030;
			Weight = 5.0;
		...
		public BowOfTheDivineForest( Serial serial ) : base( serial )
		{
		}
