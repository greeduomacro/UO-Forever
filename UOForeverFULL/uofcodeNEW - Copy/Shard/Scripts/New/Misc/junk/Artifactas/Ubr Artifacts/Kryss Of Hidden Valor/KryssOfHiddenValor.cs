...
namespace Server.Items
{
	...
	public class KryssOfHiddenValor : BaseSword
	{
		...
		[Constructable]
		public KryssOfHiddenValor() : base( 0x1401 )
		{
			Name = "Kryss Of Hidden Valor";
			Hue = 1202;
			Weight = 2.0;
		...
		public KryssOfHiddenValor( Serial serial ) : base( serial )
		{
		}
