...
namespace Server.Items
{
	...
	public class DaggerOfPoisonedSpeed : BaseKnife
	{
public override int ArtifactRarity{ get{ return 15; } }
		...
		[Constructable]
		public DaggerOfPoisonedSpeed() : base( 0xF52 )
		{
			Name = "Dagger Of Poisoned Speed";
			Weight = 1.0;
			Hue = 2217;
		}

		public DaggerOfPoisonedSpeed( Serial serial ) : base( serial )
		{
		}
