...
namespace Server.Misc
{
    public static partial class Assistants
    {
        private static class Settings
        {
            ...
            public static readonly TimeSpan HandshakeTimeout = TimeSpan.FromSeconds(15.0);
            ...
            {
                DisallowFeature(Features.Autoloot);
                DisallowFeature(Features.FilterWeather);
                DisallowFeature(Features.AutoPotionEquip);
                DisallowFeature(Features.SellAgent);
                DisallowFeature(Features.OverheadHealth);
                DisallowFeature(Features.BoneCutterAgent);
            ...
            public enum Features : ulong
            {
                ...
                PoisonedChecks = 1 << 7,  // Block heal if poisoned option, mobile (self included) poison checks via macros
                LoopedMacros = 1 << 8,  // Disallow looping and recursive macros
                ...
                Autoloot = 1 << 17, // Autoloot agent and macros
            ...
            {
                get { return m_DisallowedFeatures; }
            }
        }
        ...
        public static class Negotiator
        {
            ...
            public static void NegotiateFeatures(Mobile m)
            {
            ...
            private static void RazorCheck_Command(CommandEventArgs e)
            {
