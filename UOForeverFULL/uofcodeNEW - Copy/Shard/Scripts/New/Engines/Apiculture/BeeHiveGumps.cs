...
{
	public class BeehiveMainGump : Gump
	{
		Beehive m_hive;
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			switch ( info.ButtonID )
			{
				...
				case 2: //Destroy
				{
					from.SendGump( new BeehiveDestroyGump( from, m_hive ) );
					break;
				}
				case 3: //Help
				{
					from.SendGump( new BeehiveMainGump( from, m_hive ) );
					from.SendGump( new BeehiveHelpGump( from, 0 ) );
					break;
				}
	...
	public class BeehiveProductionGump : Gump
	{
	...
	public class BeehiveDestroyGump : Gump
	{
		Beehive m_hive;
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			switch ( info.ButtonID )
			{
				...
				{
					BeehiveDeed deed = new BeehiveDeed();
