...
{
	public class BeehiveHelpGump : Gump
	{
		public BeehiveHelpGump( Mobile from, int type ) : base( 20, 20 )
		{
			Closable=true;
			Disposable=true;
			Dragable=true;
		...
		public string HelpText(int type)
		{
			...
			switch( type )
			{
				case 0:
				{
					...
					text += "<p><b>Apiculture</b> or <b>beekeeping</b> is the science (and some say art) of raising honey bees.  Bees live together in <b>colonies</b> and make their homes in <b>beehives</b>.  Tending a hive is not as easy as it may sound, although it can be a very rewarding experience.  To start on the path of the <b>apiculturist</b>, all one needs is a <b>beehive deed</b> and an area with plenty of <b>flowers</b> and <b>water</b>.</p>";
					...
					text += "<p>Managing and caring for the hive is done using the <b>apiary gump</b>.  Almost every aspect of the hive can be monitored from here.  Down the left side of the gump are the status icons:</p>";
				...
				case 1:
				{
					text +="<p>Beeswax in its raw form straight from the hive is full of impurities making it diffiuclt to work with.  The process of purifying raw wax is called <b>rendering</b>.</p>";
