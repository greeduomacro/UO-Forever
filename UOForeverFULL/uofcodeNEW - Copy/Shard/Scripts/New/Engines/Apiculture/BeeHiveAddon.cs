...
{
	public class Beehive : BaseAddon
	{
		...
		BeesComponent m_Bees; //for displaying bee swarm
		...
		BeehiveComponent m_Comp; //for storing the top of the hive
		...
		public BeehiveComponent BeehiveComponent { get{ return m_Comp; } }

		[Constructable]
		public Beehive()
		{
			AddComponent( new AddonComponent( 2868 ),0,0, 0 ); //table
			//AddComponent( new BeehiveComponent(this),0,0,+6 ); //beehive
			m_Comp = new BeehiveComponent(this);
			AddComponent( m_Comp,0,0,+6);
			m_Bees = new BeesComponent(this);
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			m_Bees = (BeesComponent)reader.ReadItem();  //for displaying bee swarm
			...
			m_Comp = (BeehiveComponent)reader.ReadItem();  //for storing the top of the hive
...
*/
	...
	public class BeesComponent : AddonComponent
	{
		Beehive m_Hive;
		...
		public BeesComponent( Serial serial ) : base( serial )
		{
		}
	...
	public class BeehiveComponent : AddonComponent
	{
		Beehive m_Hive;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if( m_Hive.HiveStage == HiveStatus.Empty )
				LabelTo( from, "That beehive is empty.  Use an axe to redeed it." );
			else
			{
				from.CloseGump( typeof( BeehiveMainGump ) );
		...
		public override void GetProperties(ObjectPropertyList list)
		{
			...
			if( m_Hive != null )  //just in case
			{
				...
				if( m_Hive.HiveStage >= HiveStatus.Producing )
					list.Add( 1060662,"{0}\t{1}" ,"Colony", m_Hive.Population + "OK bees" );
			}
		}

		public BeehiveComponent( Serial serial ) : base( serial )
		{
		}
	...
	{
		public override BaseAddon Addon{ get{ return new Beehive(); } }

		public override string DefaultName{ get{ return "a deed for a beehive"; } }
