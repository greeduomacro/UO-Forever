...
namespace Server.Items
{
	public class LargeWaxPot : Item
	{
		...
		[Constructable]
		public LargeWaxPot() : this( 50 )
		{
		}

		public override string DefaultName{ get{ return "a large wax pot"; } }

		[Constructable]
		public LargeWaxPot( int uses ) : base( 2541 )
		{
		...
		public LargeWaxPot( Serial serial ) : base( serial )
		{
		}
