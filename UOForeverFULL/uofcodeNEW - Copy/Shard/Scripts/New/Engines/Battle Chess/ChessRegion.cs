...
{
	public class ChessRegion : BaseRegion
	{
		/// <summary>
		...
		public ChessRegion( Map map, ChessGame game, bool allowSpectators, Rectangle2D bounds, int height ) : base( "Chessboard", map, 100, new Rectangle2D( bounds.X - 12, bounds.Y - 12, bounds.Width + 24, bounds.Height + 24 ) )
		{
			m_Game = game;
		...
		private void ForceExpel()
		{
			if ( m_Game != null && ! m_AllowSpectators )
			{
				...
				List<Mobile> expel = new List<Mobile>();
