...
namespace Server.Items 
{
    ...
    {
        None = 0x00000000,
        CannotTrade = 0x00000001,
        AlwaysGrey = 0x00000002,
        NoMurderCounts = 0x00000004,
        NoFactionEffects = 0x00000008,
        NoFameKarma = 0x00000010,
        CannotTakeRewards = 0x00000020,
        CastWithoutReagents = 0x00000040,
        IsDungeonRegion	    = 0x00000080,
        IsGameRegion = 0x00000100,
        CanMoveThrough = 0x00000200,
        KillExit = 0x00000400,
        //IsCTF = 0x00000800,
        IsCraftRegion = 0x00001000,
        AllowRecallIn = 0x00002000,
        AllowGateIn = 0x00004000,
        ForceMobReturnHome = 0x00008000,
        AllowHiding = 0x00010000,
        YoungProtected = 0x00020000,
        AllowCutCorpse = 0x00040000,
        NoStatLoss = 0x00080000,
        NoMounts = 0x00100000,
        NoPets = 0x00200000,
        IsSafeZone = 0x00400000,
        IsT2AZone = 0x00800000
    }
	...
	public class RegionControl : Item
	{
        ...
        {
            get { return GetFlag(ExtRegionFlag.CannotTrade); }
            set { SetFlag(ExtRegionFlag.CannotTrade, value); }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public bool AllowRecallIn
        {
            get { return GetFlag(ExtRegionFlag.AllowRecallIn); }
            set { SetFlag(ExtRegionFlag.AllowRecallIn, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool AllowGateIn
        {
            get { return GetFlag(ExtRegionFlag.AllowGateIn); }
            set { SetFlag(ExtRegionFlag.AllowGateIn, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool AllowHiding
        {
            get { return GetFlag(ExtRegionFlag.AllowHiding); }
            set { 
                SetFlag(ExtRegionFlag.AllowHiding, value);
                if (value == false && Region != null)
                {
                    List<Mobile> mobs = Region.GetMobiles();
                    foreach (Mobile mob in mobs)
                    {
                        if (!mob.Deleted && mob.Hidden && mob.AccessLevel == AccessLevel.Player)
                        {
                            mob.RevealingAction(false);
                            mob.LocalOverheadMessage(MessageType.Regular, 38, false, "Your cover has been blown!");
                        }
                    }
                }
            }
        ...
        {
            get { return GetFlag(ExtRegionFlag.NoMounts); }
            set { SetFlag(ExtRegionFlag.NoMounts, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool NoPets
        {
            get { return GetFlag(ExtRegionFlag.NoPets); }
            set { SetFlag(ExtRegionFlag.NoPets, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool NoStatLoss
        {
            get { return GetFlag(ExtRegionFlag.NoStatLoss); }
            set { SetFlag(ExtRegionFlag.NoStatLoss, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool AllowCutCorpse
        {
            get { return GetFlag(ExtRegionFlag.AllowCutCorpse); }
            set { SetFlag(ExtRegionFlag.AllowCutCorpse, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool YoungProtected
        {
            get { return GetFlag(ExtRegionFlag.YoungProtected); }
            set { SetFlag(ExtRegionFlag.YoungProtected, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool ForceMobReturnHome
        {
            get { return GetFlag(ExtRegionFlag.ForceMobReturnHome); }
            set { SetFlag(ExtRegionFlag.ForceMobReturnHome, value); }
        }
        ...
        {
            get { return GetFlag(ExtRegionFlag.IsGameRegion); }
            set { SetFlag(ExtRegionFlag.IsGameRegion, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool CanMoveThrough
        {
            get { return GetFlag(ExtRegionFlag.CanMoveThrough); }
            set { SetFlag(ExtRegionFlag.CanMoveThrough, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool KillExit
        {
            get { return GetFlag(ExtRegionFlag.KillExit); }
            set { SetFlag(ExtRegionFlag.KillExit, value); }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool IsCraftRegion
        {
            get { return GetFlag(ExtRegionFlag.IsCraftRegion); }
            set { SetFlag(ExtRegionFlag.IsCraftRegion, value); }
        }
        ...
        {
            get { return GetFlag(ExtRegionFlag.IsDungeonRegion); }
            set
            {
                SetFlag(ExtRegionFlag.IsDungeonRegion, value);
            }
        }
        ...
        {
            get { return GetFlag(ExtRegionFlag.IsSafeZone); }
            set
            {
                SetFlag(ExtRegionFlag.IsSafeZone, value);
            }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool IsT2AZone
        {
            get { return GetFlag(ExtRegionFlag.IsT2AZone); }
            set
            {
                SetFlag(ExtRegionFlag.IsT2AZone, value);
            }
        }
        ...
        public static void OnLogout(LogoutEventArgs e)
        {
            ...
            if (customRegion != null && customRegion.Controller.LogoutMoveMap != null && customRegion.Controller.LogoutMoveMap != Map.Internal && e.Mobile.AccessLevel == AccessLevel.Player)
