...
namespace Server.Items
{
	...
	public class HolidayBust : BaseHolidayGift
	{
		...
		public HolidayBust(int year)
		{
			...
			Name = "a bust of " + RandomList<string>( m_Names );
		...
		public HolidayBust( Serial serial ) : base( serial )
		{
		}
