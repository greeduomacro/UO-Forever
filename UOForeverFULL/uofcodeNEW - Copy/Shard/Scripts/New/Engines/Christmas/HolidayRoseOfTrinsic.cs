...
namespace Server.Items
{
	...
	public class HolidayRose : Item, ISecurable, ITokunoDyable
	{
		...
		[Constructable]
		public HolidayRose() : base( 0x0EB0 )
		{
			Name = "A Holiday Rose";
		...
		{
			private HolidayRose m_Rose;

			public SpawnTimer( HolidayRose rose, TimeSpan delay ) : base( delay )
			{
				m_Rose = rose;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			{
				from.AddToBackpack( new HolidayRosePetal( Petals ) );
				Petals = 0;
			}
		}

		public HolidayRose( Serial serial ) : base( serial )
		{
		}
	...
	public class HolidayRosePetal : Item
	{
		public override int LabelNumber{ get{ return 1062926; } } // Petal of the Rose of Trinsic

		[Constructable]
		public HolidayRosePetal() : this( 1 )
		{
		}

		[Constructable]
		public HolidayRosePetal( int amount ) : base( 0x1021 )
		{
			Name = "Holiday Rose Petal";
			Hue = 32;
			Stackable = true;
			Amount = amount;
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( from.GetStatMod( "HolidayRosePetal" ) != null )
			{
			...
			else
			{
				...
				from.AddStatMod( new StatMod( StatType.Dex, "HolidayRosePetal", 5, TimeSpan.FromMinutes( 5.0 ) ) );

				Consume();
			}
		}

		public HolidayRosePetal( Serial serial ) : base( serial )
		{
		}
