...
{
	[CorpseName( "a elder daemon corpse" )]
	public class ElderDaemon : BaseCreature
	{
		[Constructable]
		public ElderDaemon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a elder daemon";
			Body = 755;
		...
		public ElderDaemon( Serial serial ) : base( serial )
		{
		}
		...
		{
			private ElderDaemon d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, ElderDaemon owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
