...
{
	[CorpseName( "a young daemon corpse" )]
	public class YoungDaemon : BaseCreature
	{
		[Constructable]
		public YoungDaemon() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a young daemon";
			Body = 4;
		...
		public YoungDaemon(Serial serial) : base(serial)
		{
		}
		...
		{
			private YoungDaemon d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, YoungDaemon owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
