...
{
	[CorpseName( "a daemon destroyer corpse" )]
	public class DaemonDestroyer : BaseCreature
	{
		[Constructable]
		public DaemonDestroyer () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a daemon destroyer";
			Body = 754;
		...
		public DaemonDestroyer( Serial serial ) : base( serial )
		{
		}
		...
		{
			private DaemonDestroyer d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, DaemonDestroyer owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
