...
{
	[CorpseName( "a daemon hatchling" )]
	public class DaemonHatchling : BaseCreature
	{
		[Constructable]
		public DaemonHatchling() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public DaemonHatchling(Serial serial) : base(serial)
		{
		}
		...
		{
			private DaemonHatchling d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, DaemonHatchling owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
