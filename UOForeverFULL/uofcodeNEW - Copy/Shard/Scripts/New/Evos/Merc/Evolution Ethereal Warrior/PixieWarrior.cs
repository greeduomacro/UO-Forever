...
{
	[CorpseName( "a pixie warrior corpse" )]
	public class PixieWarrior : BaseCreature
	{
		[Constructable]
		public PixieWarrior() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a pixie warrior";
			Body = 128;
		...
		public PixieWarrior(Serial serial) : base(serial)
		{
		}
		...
		{
			private PixieWarrior d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, PixieWarrior owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
