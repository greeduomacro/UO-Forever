...
{
	[CorpseName( "a guardian warrior corpse" )]
	public class GuardianWarrior : BaseCreature
	{
		public Timer m_DeathTimer;

		[Constructable]
		public GuardianWarrior () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a guardian warrior";
			Body = 175;
			BaseSoundID = 0;
			Hue = 0;
		...
		public GuardianWarrior( Serial serial ) : base( serial )
		{
		}
		...
		{
			private GuardianWarrior d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, GuardianWarrior owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
