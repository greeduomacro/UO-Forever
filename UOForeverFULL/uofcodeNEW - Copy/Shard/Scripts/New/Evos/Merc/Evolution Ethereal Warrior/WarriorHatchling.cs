...
{
	[CorpseName( "a warrior hatchling" )]
	public class WarriorHatchling : BaseCreature
	{
		[Constructable]
		public WarriorHatchling() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public WarriorHatchling(Serial serial) : base(serial)
		{
		}
		...
		{
			private WarriorHatchling d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, WarriorHatchling owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
