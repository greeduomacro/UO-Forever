...
{
	[CorpseName( "an imp warrior corpse" )]
	public class ImpWarrior : BaseCreature
	{
		[Constructable]
		public ImpWarrior () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a imp warrior";
		...
		public ImpWarrior( Serial serial ) : base( serial )
		{
		}
		...
		{
			private ImpWarrior d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, ImpWarrior owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
