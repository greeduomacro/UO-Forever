...
{
	[CorpseName( "a harpy warrior corpse" )]
	public class HarpyWarrior : BaseCreature
	{
		[Constructable]
		public HarpyWarrior () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a harpy warrior";
			Body = 30;
		...
		public HarpyWarrior( Serial serial ) : base( serial )
		{
		}
		...
		{
			private HarpyWarrior d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, HarpyWarrior owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
