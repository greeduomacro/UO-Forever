...
{
	[CorpseName( "an ancient warrior corpse" )]
	public class AncientWarrior : BaseCreature
	{
		[Constructable]
		public AncientWarrior () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an ancient warrior";
			Body = 123;
		...
		public AncientWarrior( Serial serial ) : base( serial )
		{
		}
		...
		{
			private AncientWarrior d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, AncientWarrior owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
