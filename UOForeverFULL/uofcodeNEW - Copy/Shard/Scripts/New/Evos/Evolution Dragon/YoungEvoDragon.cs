...
namespace Server.Mobiles
{
	...
	public class YoungEvoDragon : BaseCreature
	{
		[Constructable]
		public YoungEvoDragon () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a young dragon";
		...
		public YoungEvoDragon( Serial serial ) : base( serial )
		{
		}
		...
		{
			private YoungEvoDragon d;
			private Mobile m_Mobile;

			public BreatheTimer( Mobile m, YoungEvoDragon owner ) : base( TimeSpan.FromSeconds( 1.0 ), TimeSpan.FromSeconds( 1.0 ) )
			{
				d = owner;
				m_Mobile = m;
			}
