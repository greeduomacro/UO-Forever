...
namespace VitaNex.Items
{
    ...
    public class ForeverStrobeRobe : BaseOuterTorso
    {
        ...
        [Constructable]
        public ForeverStrobeRobe() : base(0x1F03, 0x486)
        {
            ...
            HueCycle = new short[] {1755, 1756, 1757, 1758, 1759};

            LootType = LootType.Blessed;
        }

        public ForeverStrobeRobe(Serial serial)
            : base(serial)
        {}
