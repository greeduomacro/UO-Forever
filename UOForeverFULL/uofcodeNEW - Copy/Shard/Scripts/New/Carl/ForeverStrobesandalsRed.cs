...
{
    public class ForeverStrobeSandalsRed : Sandals
    {
        ...
        [Constructable]
        public ForeverStrobeSandalsRed() : base()
        {
            Name = "Forever Strobe Sandals";
            Weight = 3;
            Hue = 0;
        ...
        public ForeverStrobeSandalsRed(Serial serial)
            : base(serial)
        {}
