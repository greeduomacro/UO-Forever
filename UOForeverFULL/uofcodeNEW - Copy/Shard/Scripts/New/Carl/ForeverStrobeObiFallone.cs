...
namespace VitaNex.Items
{
    ...
    public class ForeverStrobeObiFallon : BaseWaist
    {
        ...
        [Constructable]
        public ForeverStrobeObiFallon() : base(10144)
        {
            Name = "Forever Strobe Belt";
            Weight = 3;
            Hue = 0;
            ...
            HueCycle = new short[] {2963, 2964, 2965, 2966};

            LootType = LootType.Blessed;
        }

        public ForeverStrobeObiFallon(Serial serial)
            : base(serial)
        {}
