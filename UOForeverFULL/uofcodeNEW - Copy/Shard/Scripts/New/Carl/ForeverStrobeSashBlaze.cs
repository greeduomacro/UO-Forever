...
namespace VitaNex.Items
{
    ...
    public class ForeverStrobeSashBlaze : BaseMiddleTorso
    {
        ...
        [Constructable]
        public ForeverStrobeSashBlaze() : base(0x1541)
        {
            Name = "Forever Strobe Sash";
            Weight = 3;
            Hue = 0;
            ...
            HueCycle = new short[] {1255, 1256, 1257, 1258, 1259, 1260};

            LootType = LootType.Blessed;
        }

        public ForeverStrobeSashBlaze(Serial serial)
            : base(serial)
        {}
