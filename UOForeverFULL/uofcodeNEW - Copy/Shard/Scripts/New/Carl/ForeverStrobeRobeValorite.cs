...
namespace VitaNex.Items
{
    ...
    public class ForeverStrobeRobeValorite : BaseOuterTorso
    {
        ...
        [Constructable]
        public ForeverStrobeRobeValorite() : base(0x1F03, 0x486)
        {
            ...
            HueCycle = new short[] {2001, 2002, 2003, 2004, 2005, 2006};

            LootType = LootType.Blessed;
        }

        public ForeverStrobeRobeValorite(Serial serial)
            : base(serial)
        {}
