...
namespace VitaNex.Items
{
    ...
    public class ForeverStrobeApronBlaze : BaseWaist
    {
        ...
        [Constructable]
        public ForeverStrobeApronBlaze() : base(0x153b)
        {
            Name = "Forever Strobe Apron";
            Weight = 3;
            Hue = 0;
        ...
        public ForeverStrobeApronBlaze(Serial serial)
            : base(serial)
        {}
