...
namespace Server.Items
{
    ...
    public class BombermanControlItem : BoardGameControlItem
    {
        ...
        public override string GameDescription
        {
            ...
            {
                return
                    "Blow up walls and players with bombs.  Collect upgrades to improve your number of bombs, blast size, etc.";
            }
        }
        ...
        public override string GameRules
        {
            ...
            {
                return
                    "Each game can have up to eight players, and everyone starts in a corner or edge of the arena.  " +
        ...
        public override void AddPlayer(Mobile m)
        {
            ...
            if (Players.Count == 1 && _AllowPlayerConfiguration)
            {
                PublicOverheadMessage(MessageType.Regular, 1153, false,
                    Players[0].Name + " is now in charge of this game!");
            ...
            if (Players.Count < CurrentMaxPlayers)
            {
                ...
                PublicOverheadMessage(MessageType.Regular, 1153, false, requiredplayers + " more needed!");
            }
            else
            {
        ...
        public override void RemovePlayer(Mobile m)
        {
            ...
            {
                PublicOverheadMessage(MessageType.Regular, 1153, false,
                    Players[1].Name + " is now in charge of this game!");
                SettingsReady = false;
