    ...
    public abstract class BoardGameControlItem : Item
    {
        ...
        public bool SettingsReady
        {
            ...
            set
            {
                ...
                if (_SettingsReady && Players.Count == CurrentMaxPlayers && _State < BoardGameState.Active &&
                    _State != BoardGameState.Disabled)
                {
                    InitializeGame();
                }
            }
        ...
        {
            get { return new Point3D(X + _BoardOffset.X, Y + _BoardOffset.Y, Z + _BoardOffset.Z); }
            set
            {
        ...
        {
            get { return _Players ?? (_Players = new List<Mobile>()); }
        }

        public List<Mobile> PendingPlayers
        {
            get { return _PendingPlayers ?? (_PendingPlayers = new List<Mobile>()); }
        }


        public List<GamePiece> BackgroundItems
        {
            get { return _BackgroundItems ?? (_BackgroundItems = new List<GamePiece>()); }
        }
        ...
        public virtual void WipeBoard()
        {
            ...
            {
                piece.BoardGameControlItem = null;
                    //detach reference to this boardgame so that it doesn't wipe the board itself
                piece.Delete();
            }
        ...
        public bool CheckCost(Mobile from, bool withdraw)
        {
            ...
            var gold = (Gold) from.Backpack.FindItemByType(typeof(Gold));
        ...
        public override void GetProperties(ObjectPropertyList list)
        {
            ...
            list.Add(1060658, "Cost to play\t{0}", CostToPlay.ToString(CultureInfo.InvariantCulture)); // ~1_val~: ~2_val~
        }
        ...
        protected class EndGameTimer : Timer
        {
            ...
            public EndGameTimer(BoardGameControlItem controlitem, TimeSpan delay)
        ...
        protected class WinnerTimer : Timer
        {
            ...
            public WinnerTimer(BoardGameControlItem controlitem, TimeSpan delay)
                : base(delay, TimeSpan.FromSeconds(1.0))
            {
                _ControlItem = controlitem;
            }
