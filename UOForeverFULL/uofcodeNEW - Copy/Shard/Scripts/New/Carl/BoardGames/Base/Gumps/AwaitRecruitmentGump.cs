    ...
    public class AwaitRecruitmentGump : BoardGameGump
    {
        ...
        public AwaitRecruitmentGump(Mobile owner, BoardGameControlItem controlitem) : base(owner, controlitem)
        {
            ...
            AddHtml(40, 50, Width - 80, 80,
                "You are waiting for more players to join this game.  When there are enough, this window will automatically close and the game will start.  If you wish to cancel waiting, click the Cancel button.",
                true, false);
