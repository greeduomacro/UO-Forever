...
namespace Joeku.SR
{
	public class SR_Main
	{
		...
		public static void Initialize()
		{
			...
			CommandHandlers.Register("StaffRunebook", AccessLevel.EventMaster, new CommandEventHandler(SR_OnCommand));
			CommandHandlers.Register("SR", AccessLevel.EventMaster, new CommandEventHandler(SR_OnCommand));
			CommandHandlers.Register("StaffRunebookReset", AccessLevel.EventMaster, new CommandEventHandler(SR_Reset_OnCommand));
