...
namespace Server.Multis
{
    ...
    {		
        ...
        [Constructable]
        public NewSmallBoat()
            : base(0x0, 100, 100, new Point3D(1, 4, 0), new Point3D(-2, 0, 0), new Point3D(2, 0, 0), new Point3D(0, -4, 0))
        {
        }
    ...
    public class NewSmallDragonBoat : NewBaseBoat
    {
        ...
        public NewSmallDragonBoat()
            : base(0x4, 100, 100, new Point3D(1, 4, 0), new Point3D(-2, 0, 0), new Point3D(2, 0, 0), new Point3D(0, -4, 0))
        {
        }
    ...
    public class NewMediumBoat : NewBaseBoat
    {
        ...
        public NewMediumBoat()
            : base(0x8, 100, 100, new Point3D(1, 5, 0), new Point3D(-2, 0, 0), new Point3D(2, 0, 0), new Point3D(0, -4, 0))
        {
        }
    ...
    public class NewMediumDragonBoat : NewBaseBoat
    {
        ...
        public NewMediumDragonBoat()
            : base(0xC, 100, 100, new Point3D(1, 5, 0), new Point3D(-2, 0, 0), new Point3D(2, 0, 0), new Point3D(0, -4, 0))
        {
        }
    ...
    public class NewLargeBoat : NewBaseBoat
    {
        ...
        [Constructable]
        public NewLargeBoat()
            : base(0x10, 100, 100, new Point3D(1, 5, 0), new Point3D(-2, -1, 0), new Point3D(2, -1, 0), new Point3D(0, -5, 0))
        {
        }
    ...
    public class NewLargeDragonBoat : NewBaseBoat
    {
        ...
        public NewLargeDragonBoat()
            : base(0x14, 100, 100, new Point3D(1, 5, 0), new Point3D(-2, -1, 0), new Point3D(2, -1, 0), new Point3D(0, -5, 0))
        {
        }
