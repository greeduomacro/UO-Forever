...
{
    [CorpseName("Wretched Rabbit's corpse")]
    public class WretchedRabbitPet : BaseCreature
    {
        ...
        [Constructable]
        public WretchedRabbitPet()
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
			Name = NameList.RandomName("pixie");
            Body = 205;
            Hue = 1157;
            SpecialTitle = "Wretched Rabbit";
            TitleHue = 1166;

            Tamable = true;

            SpeechHue = YellHue = 1157;
        ...
        public WretchedRabbitPet(Serial serial)
            : base(serial)
        {}
