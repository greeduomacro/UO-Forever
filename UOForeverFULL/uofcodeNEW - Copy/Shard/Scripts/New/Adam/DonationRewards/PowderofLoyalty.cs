...
{
    public class PowderOfLoyalty : Item
    {
        [Constructable]
        public PowderOfLoyalty()
            : this(1)
        {}

        [Constructable]
        public PowderOfLoyalty(int amount)
            : base(0x26B8)
        {
            Name = "powder of loyalty";
            Hue = 1366;
            Stackable = true;
            Weight = 0.1;
        ...
        public PowderOfLoyalty(Serial serial)
            : base(serial)
        {}
        ...
        {
            private readonly PowderOfLoyalty m_Powder;

            public InternalTarget(PowderOfLoyalty powder)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is WandofLoyalty)
                {
                    ...
                    wand.LoyaltyCharges += m_Powder.Amount;
                    m_Powder.Delete();
