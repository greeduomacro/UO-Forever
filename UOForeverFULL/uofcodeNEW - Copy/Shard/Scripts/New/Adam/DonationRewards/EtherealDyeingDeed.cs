...
{
	public class EtherealDye : Target // Create our targeting class (which we derive from the base target class)
	{
        private readonly EtherealDyeDeed _mDeed;

        public EtherealDye(EtherealDyeDeed deed)
	...
	public class EtherealDyeDeed : Item // Create the item class which is derived from the base item class
	{
        [CommandProperty(AccessLevel.GameMaster)]
        public ItemTypeSelectProperty EtherealType { get; set; }

		[Constructable]
		public EtherealDyeDeed() : base( 0x14F0 )
		{
            Name = "an ethereal dyeing deed";
			Weight = 1.0;
        ...
        public EtherealDyeDeed(Serial serial)
            : base(serial)
		{
		}
		...
		public override void OnDoubleClick( Mobile from ) // Override double click of the deed to call our target
		{
			...
			else
			{
                ...
                from.Target = new EtherealDye(this); // Call our target
			}
		}
	}
}