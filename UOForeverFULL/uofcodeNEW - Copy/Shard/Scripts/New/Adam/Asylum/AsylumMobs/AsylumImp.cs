...
namespace Server.Mobiles
{
	...
	public class AsylumImp : BaseCreature
	{
		[Constructable]
		public AsylumImp() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
        ...
        public AsylumImp(Serial serial)
            : base(serial)
		{
		}
        ...
        public override void OnDeath(Container c)
        {
            ...
            {
                c.DropItem(new WristWatch { Hue = 1289, LootType = LootType.Regular, Name = "an impish watch"});
            }
            base.OnDeath(c);
        }
