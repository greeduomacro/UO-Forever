...
{
	[Flipable]
	public class BloodstainedRing : BaseRing
	{
		...
		[Constructable]
		public BloodstainedRing() : base( 4234 )
		{
			Weight = 1.0;
			Dyable = false;
            Hue = 2117;
		    Name = "Bloodstained Ring";
		}

        public BloodstainedRing(Serial serial)
            : base(serial)
		{
		}
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            LabelTo(from, "This ring signifies a pact with the lord of the night.", 137);
        }
