...
{
	[Flipable]
	public class BloodstainedEarrings : BaseEarrings
	{
		...
		[Constructable]
		public BloodstainedEarrings() : base( 4231 )
		{
			Weight = 1.0;
			Dyable = false;
            Hue = 2117;
		    Name = "Bloodstained Earrings";
		}

        public BloodstainedEarrings(Serial serial)
            : base(serial)
		{
		}
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            LabelTo(from, "These earrings signify a pact with the lord of the night.", 137);
        }
