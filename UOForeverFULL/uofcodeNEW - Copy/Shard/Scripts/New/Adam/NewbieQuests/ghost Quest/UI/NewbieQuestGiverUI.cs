...
{
    public class NewbieQuestGiverUI : NoticeDialogGump
    {
        private string HTML;

        public NewbieQuestGiverUI(
            PlayerMobile user,
            Gump parent = null,
            int? x = null,
            int? y = null,
        ...
        protected override void CompileLayout(SuperGumpLayout layout)
        {
            layout.Add(
                ...
                () =>
                {
                    ...
                    AddImage(90, 33, 9005);
                    AddHtml(130, 45, 270, 20, Title.WrapUOHtmlColor(Color.White).WrapUOHtmlTag("BIG"), false, false); // Quest Offer
                    AddImageTiled(130, 65, 175, 1, 9101);

                    AddImage(140, 110, 1209);
                    AddHtml(160, 108, 250, 20, "Vengeance".WrapUOHtmlColor(Color.Orange).WrapUOHtmlTag("BIG"), false, false);
                    ...
                    AddHtml(157, 387, 280, 20, "No thanks, I decline.".WrapUOHtmlColor(Color.White), false, false); // No thanks, I decline.
