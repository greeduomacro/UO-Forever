...
{
	[Flags]
	public enum ArmsLoreSkillScrollFlags
	{
		None	= 0x00,
		Newbie	= 0x01,
		Expires	= 0x02
	...
	public class ArmsLoreSkillScroll : Item
	{
		private int m_SkillBonus;
		private ArmsLoreSkillScrollFlags m_Flags;
		private DateTime m_ExpireDate;

		public ArmsLoreSkillScrollFlags Flags{ get{ return m_Flags; } set{ m_Flags = value; } }
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public bool NewbieBall{ get{ return GetFlag( ArmsLoreSkillScrollFlags.Newbie ); } set{ SetFlag( ArmsLoreSkillScrollFlags.Newbie, value ); UpdateHue(); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public bool Expires{ get{ return GetFlag( ArmsLoreSkillScrollFlags.Expires ); } set{ SetFlag( ArmsLoreSkillScrollFlags.Expires, value ); InvalidateProperties(); } }

		public bool GetFlag( ArmsLoreSkillScrollFlags flag )
		{
			return ( m_Flags & flag ) != 0;
		}

		public void SetFlag( ArmsLoreSkillScrollFlags flag, bool value )
		{
			if ( value )
				m_Flags |= flag;
			else
		...
		[Constructable]
		public ArmsLoreSkillScroll( int bonus, bool newbied, int days ) : base( 8800 )
		{
			m_SkillBonus = bonus;
			NewbieBall = newbied;
			if ( days > -1 )
		...
		[Constructable]
		public ArmsLoreSkillScroll( int bonus, bool newbied ) : this( bonus, false, -1 )
		{
		}

		[Constructable]
		public ArmsLoreSkillScroll( int bonus ) : this( bonus, false )
		{
		}

		[Constructable]
		public ArmsLoreSkillScroll() : this( 1 )
		{
            Weight = 1;
		}

		public ArmsLoreSkillScroll( Serial serial ) : base( serial )
		{
		}

		public override bool Nontransferable{ get { return false; } }

		public override string DefaultName{ get{ return "a ArmsLore Skill Scroll"; } }
		...
		public virtual void UpdateName()
		{
			if ( Expires )
				...
				Name = "a +1 ArmsLore skill scroll";
		}
		...
		public virtual string GetLabelName()
		{
			...
			return "a +{0} ArmsLore Skill Scroll";
		}
		...
		{
			from.SendGump( new ArmsLoreSkillScrollGump( from, from, this ) );
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( !from.HasGump( typeof(ArmsLoreSkillScroll) ) )
				SendGump( from );
			else
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 1:
				{
					m_Flags = (ArmsLoreSkillScrollFlags)reader.ReadEncodedInt();
...
{
	public class ArmsLoreSkillScrollGump : Gump
	{
		private const int FieldsPerPage = 1;

		private Skill m_Skill;
		private ArmsLoreSkillScroll m_ArmsLoreSkillScroll;
		private Mobile m_Target;

		public ArmsLoreSkillScrollGump ( Mobile from, Mobile target, ArmsLoreSkillScroll ball ) : base ( 20, 20 )
		{
			m_ArmsLoreSkillScroll = ball;
			m_Target = target;
			...
			SkillName[] allowedskills = m_ArmsLoreSkillScroll.GetAllowedSkills();
			...
			for ( int i = 0; i < allowedskills.Length; ++i )
			{
				...
				if ( (!m_ArmsLoreSkillScroll.NewbieBall || skill.Base == 0) && (skill.Base + m_ArmsLoreSkillScroll.SkillBonus) <= skill.Cap && skill.Lock == SkillLock.Up )
				{
