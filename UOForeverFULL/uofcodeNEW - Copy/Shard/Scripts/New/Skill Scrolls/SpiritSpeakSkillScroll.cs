...
{
	[Flags]
	public enum SpiritSpeakSkillScrollFlags
	{
		None	= 0x00,
		Newbie	= 0x01,
		Expires	= 0x02
	...
	public class SpiritSpeakSkillScroll : Item
	{
		private int m_SkillBonus;
		private SpiritSpeakSkillScrollFlags m_Flags;
		private DateTime m_ExpireDate;

		public SpiritSpeakSkillScrollFlags Flags{ get{ return m_Flags; } set{ m_Flags = value; } }
		...
		[CommandProperty( AccessLevel.GameMaster )]
		public bool NewbieBall{ get{ return GetFlag( SpiritSpeakSkillScrollFlags.Newbie ); } set{ SetFlag( SpiritSpeakSkillScrollFlags.Newbie, value ); UpdateHue(); } }

		[CommandProperty( AccessLevel.GameMaster )]
		public bool Expires{ get{ return GetFlag( SpiritSpeakSkillScrollFlags.Expires ); } set{ SetFlag( SpiritSpeakSkillScrollFlags.Expires, value ); InvalidateProperties(); } }

		public bool GetFlag( SpiritSpeakSkillScrollFlags flag )
		{
			return ( m_Flags & flag ) != 0;
		}

		public void SetFlag( SpiritSpeakSkillScrollFlags flag, bool value )
		{
			if ( value )
				m_Flags |= flag;
			else
		...
		[Constructable]
		public SpiritSpeakSkillScroll( int bonus, bool newbied, int days ) : base( 8800 )
		{
			m_SkillBonus = bonus;
			NewbieBall = newbied;
			if ( days > -1 )
		...
		[Constructable]
		public SpiritSpeakSkillScroll( int bonus, bool newbied ) : this( bonus, false, -1 )
		{
		}

		[Constructable]
		public SpiritSpeakSkillScroll( int bonus ) : this( bonus, false )
		{
		}

		[Constructable]
		public SpiritSpeakSkillScroll() : this( 1 )
		{
            Weight = 1;
		}

		public SpiritSpeakSkillScroll( Serial serial ) : base( serial )
		{
		}

		public override bool Nontransferable{ get { return false; } }

		public override string DefaultName{ get{ return "a SpiritSpeak Skill Scroll"; } }
		...
		public virtual void UpdateName()
		{
			if ( Expires )
				...
				Name = "a +1 SpiritSpeak skill scroll";
		}
		...
		public virtual string GetLabelName()
		{
			...
			return "a +{0} SpiritSpeak Skill Scroll";
		}
		...
		{
			from.SendGump( new SpiritSpeakSkillScrollGump( from, from, this ) );
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( !from.HasGump( typeof(SpiritSpeakSkillScroll) ) )
				SendGump( from );
			else
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				case 1:
				{
					m_Flags = (SpiritSpeakSkillScrollFlags)reader.ReadEncodedInt();
...
{
	public class SpiritSpeakSkillScrollGump : Gump
	{
		private const int FieldsPerPage = 1;

		private Skill m_Skill;
		private SpiritSpeakSkillScroll m_SpiritSpeakSkillScroll;
		private Mobile m_Target;

		public SpiritSpeakSkillScrollGump ( Mobile from, Mobile target, SpiritSpeakSkillScroll ball ) : base ( 20, 20 )
		{
			m_SpiritSpeakSkillScroll = ball;
			m_Target = target;
			...
			SkillName[] allowedskills = m_SpiritSpeakSkillScroll.GetAllowedSkills();
			...
			for ( int i = 0; i < allowedskills.Length; ++i )
			{
				...
				if ( (!m_SpiritSpeakSkillScroll.NewbieBall || skill.Base == 0) && (skill.Base + m_SpiritSpeakSkillScroll.SkillBonus) <= skill.Cap && skill.Lock == SkillLock.Up )
				{
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			if ( from == null || m_SpiritSpeakSkillScroll.Deleted )
				return;

			if ( m_SpiritSpeakSkillScroll.Expires && DateTime.UtcNow >= m_SpiritSpeakSkillScroll.ExpireDate )
				m_SpiritSpeakSkillScroll.SendLocalizedMessageTo( from, 1042544 ); // This item is out of charges.
			else if ( !m_SpiritSpeakSkillScroll.IsChildOf( from.Backpack ) )
				from.SendLocalizedMessage( 1042001 ); // That must be in your pack for you to use it.
			else if (info.ButtonID == 1)
			{
				SkillName skillname = (m_SpiritSpeakSkillScroll.GetAllowedSkills())[info.ButtonID-1];
				...
				int bonus = m_SpiritSpeakSkillScroll.SkillBonus;

				List<Skill> decreased = m_SpiritSpeakSkillScroll.GetDecreasableSkills( from, m_Target, count, cap, out decreaseamount );
				...
				else if ( m_SpiritSpeakSkillScroll.NewbieBall && m_Skill.Base > 0 )
				...
				else
				{
					...
					{
						m_SpiritSpeakSkillScroll.DecreaseSkills( from, m_Target, decreased, count, cap, decreaseamount );
						m_SpiritSpeakSkillScroll.IncreaseSkill( from, m_Target, m_Skill );

						if ( !m_SpiritSpeakSkillScroll.Rechargable )
							m_SpiritSpeakSkillScroll.Delete();
					}
					else
