	...
	public class Unicorn : BaseMount
	{
		...
		public override bool DoMountAbility( int damage, Mobile attacker )
		{
			...
			if( Rider.Poisoned && ((Rider.Hits - damage) < 40) )
			{
				...
				if( p != null )
				{
					int chanceToCure = 10000 + (int)(this.Skills[SkillName.Magery].Value * 75) - ((p.Level + 1) * (EraAOS ? (p.Level < 4 ? 3300 : 3100) : 1750));
					chanceToCure /= 100;
        ...
        public override int InternalItemItemID { get { return 0x3EB4; } }

		[Constructable]
		public Unicorn() : base( 0x7A, AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0x4BC;
