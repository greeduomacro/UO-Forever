...
namespace Server.Mobiles
{
	public class EtherealMount : Item, IMount, IMountItem, IRewardItem
	{
		...
		public override string LabelAttributesTo( Mobile to )
		{
			StringBuilder builder = new StringBuilder();

			if ( m_IsRewardItem )
				builder.Append( "Veteran Reward" );
            ...
            if (IsCharcoal)
            {
                ...
                builder.Append("Dyed: Charcoal");
            }

			string suffix = base.LabelAttributesTo( to );
		...
		public override void Serialize( GenericWriter writer )
		{
            ...
            writer.Write(DeedHued);
            writer.Write(IsCharcoal);
            writer.Write(IsDehued);
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
                case 6:
                    {
                        DeedHued = reader.ReadBool();
                        goto case 5;
                    }
                case 5:
                    {
                        IsCharcoal = reader.ReadBool();
                        goto case 4;
                    }
                case 4:
                {
                        IsDehued = reader.ReadBool();
                        goto case 3;
                }
				case 3:
				{
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public bool IsDehued { get; set; }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool IsCharcoal { get; set; }

        [CommandProperty(AccessLevel.GameMaster)]
        public bool DeedHued { get; set; }
