...
namespace Server.Mobiles
{
    ...
    public class SwampDragon : BaseMount
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int BardingMaxHP { get { return m_BardingExceptional ? 2500 : 1000; } }

        public override string DefaultName { get { return "a swamp dragon"; } }

        public override int InternalItemItemID { get { return 0x3EBD; } }

        [Constructable]
        public SwampDragon() : base(0x31A, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            BaseSoundID = 0x16A;
