...
namespace Server.Mobiles
{
	...
	public abstract class BaseWarHorse : BaseMount
	{
		...
		public BaseWarHorse( int bodyID, AIType aiType, FightMode fightMode, int rangePerception, int rangeFight, double activeSpeed, double passiveSpeed ) : base ( bodyID, aiType, fightMode, rangePerception, rangeFight, activeSpeed, passiveSpeed )
		{
			BaseSoundID = 0xA8;
