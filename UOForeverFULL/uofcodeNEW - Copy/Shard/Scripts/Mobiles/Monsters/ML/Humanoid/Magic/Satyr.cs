...
namespace Server.Mobiles
{
    ...
    public class Satyr : BaseCreature
    {
        ...
        {
            if (target == null || m_Suppressed.ContainsKey(target) || Deleted || !Alive || m_NextSuppress > DateTime.UtcNow ||
        ...
        {
            Timer value;
            if (target != null && m_Suppressed.TryGetValue(target, out value))
            {
                Timer timer = value;
