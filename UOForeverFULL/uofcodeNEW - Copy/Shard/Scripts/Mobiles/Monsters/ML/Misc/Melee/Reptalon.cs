...
namespace Server.Mobiles
{
	...
	{
		public override string DefaultName{ get{ return "a reptalon"; } }

        public override int InternalItemItemID { get { return 0x3E90; } }

		[Constructable]
		public Reptalon() : base( 0x114, AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.35 )
		{
			BaseSoundID = 0x16A;
