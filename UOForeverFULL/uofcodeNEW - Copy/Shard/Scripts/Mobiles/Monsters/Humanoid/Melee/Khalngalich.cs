...
{
    [CorpseName("the corpse of Khal'nga")]
    public class Khalngalich : BaseCreature
    {
      ...
      //  public override bool Unprovokable { get { return true; } } // had it in twice adam :)
        ...
        public Khalngalich(Serial serial)
            : base(serial)
        {
        }
