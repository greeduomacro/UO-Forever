...
namespace Server.Mobiles
{
	...
	public class PlagueBeast : BaseCreature, IDevourer
	{
		...
		public int TotalDevoured { get { return m_DevourTotal; } set { m_DevourTotal = value; } }

		[CommandProperty(AccessLevel.GameMaster)]
		public int DevourGoal { get { return (IsParagon ? m_DevourGoal + 25 : m_DevourGoal); } set { m_DevourGoal = value; } }

		[CommandProperty(AccessLevel.GameMaster)]
		public bool HasMetalChest { get { return m_HasMetalChest; } }
		...
		private void IncreaseHits(int hp)
		{
			...
			if (HitsMaxSeed >= maxhits)
			{
				...
				int newHits = Hits + hp + Utility.RandomMinMax(10, 20);
