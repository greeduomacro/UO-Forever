...
namespace Server.Mobiles
{
	public class FortuneTeller : BaseHealer
	{
		...
		public override bool CheckTeach(SkillName skill, Mobile from)
		{
			...
			return (skill == SkillName.Anatomy) || (skill == SkillName.Healing) || (skill == SkillName.Forensics) ||
		...
		{
			SBInfos.Add(new SBMage(Expansion));
		...
		public override void InitOutfit()
		{
			...
			{
				case 0:
					AddItem(Immovable(new SkullCap(RandomBrightHue())));
					break;
				case 1:
					AddItem(Immovable(new WizardsHat(RandomBrightHue())));
					break;
				case 2:
					AddItem(Immovable(new Bandana(RandomBrightHue())));
					break;
			}
