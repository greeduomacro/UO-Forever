...
namespace Server.Mobiles
{
	public class ArcherGuard : BaseGuard
	{
		...
		[Constructable]
		public ArcherGuard() : this( null, null )
		{
		}

		[Constructable]
		public ArcherGuard( Faction faction ) : this( null, faction )
		{
		}

		public ArcherGuard( Mobile target ) : this( target, null )
		{
		}

		public ArcherGuard( Mobile target, Faction faction ) : base( target, faction )
		{
		...
		//	private bool m_Shooting;
			...
			protected override void OnTick()
			{
				...
				{// <instakill>
					...
					if ( target is PlayerMobile && ( Faction.Find( target ) != null || Ethics.Player.Find( target ) != null ) )
