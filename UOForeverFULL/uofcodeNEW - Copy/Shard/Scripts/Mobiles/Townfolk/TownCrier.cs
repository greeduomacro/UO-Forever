...
namespace Server.Mobiles
{
	...
	public class TownCrierGump : Gump
	{
			...
			: base(50, 50)
		{
			...
			AddHtml(
				8, 8, 300 - 8 - 30, 20, "<basefont color=#FFFFFF><center>TOWN CRIER MESSAGES</center></basefont>", false, false);
	...
	public class TownCrier : Mobile, ITownCrierEntryList
	{
		...
		{
			public readonly TownCrierEntry Entry;
			public int Index;

			public NewsInfo(TownCrierEntry entry)
			{
				Entry = entry;
			}
		}
		...
		public static List<TownCrier> Instances { get { return m_Instances; } }
