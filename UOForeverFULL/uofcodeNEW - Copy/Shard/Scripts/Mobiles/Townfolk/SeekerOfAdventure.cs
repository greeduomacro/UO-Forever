...
namespace Server.Mobiles
{
	...
	{
		private static readonly string[] m_Dungeons = new[]
		{
			"Covetous", "Deceit", "Despise", "Destard", "Hythloth", "Shame", // Old Code for Pre-ML shards.
			"Wrong"
		};

		private static readonly string[] m_MLDestinations = new[]
		{
