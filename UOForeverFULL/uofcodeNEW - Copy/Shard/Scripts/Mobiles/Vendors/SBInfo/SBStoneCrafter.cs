...
namespace Server.Mobiles
{
	public class SBStoneCrafter : SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			...
			{
				Add( typeof( MasonryBook ), 500 );
				Add( typeof( StoneMiningBook ), 500 );
				...
				Add( typeof( WoodenShield ), 11 );
				Add( typeof( BlackStaff ), 14 );
				Add( typeof( GnarledStaff ), 12 );
				Add( typeof( QuarterStaff ), 10 );
				Add( typeof( ShepherdsCrook ), 9 );
				Add( typeof( Club ), 3 );
