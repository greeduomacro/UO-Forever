...
namespace Server.Mobiles
{
	public class SBBlacksmith : SBInfo
	{
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
		{
			...
			{
				Add(new GenericBuyInfo(typeof(IronIngot), 10, 15, 0x1BF2, 0));
				...
				Add(new GenericBuyInfo(typeof(SmithHammerWeapon), 21, 20, 0x13E3, 0));
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo(Expansion e)
			{
				...
				Add(typeof(Buckler), 8);
				Add(typeof(BronzeShield), 7);
				Add(typeof(MetalShield), 14);
				Add(typeof(MetalKiteShield), 18);
				Add(typeof(HeaterShield), 29);
				Add(typeof(WoodenKiteShield), 2);

				Add(typeof(WoodenShield), 2);

				Add(typeof(PlateArms), 34);
				Add(typeof(PlateChest), 51);
				Add(typeof(PlateGloves), 32);
				Add(typeof(PlateGorget), 12);
				Add(typeof(PlateLegs), 59);

				Add(typeof(FemalePlateChest), 53);
				Add(typeof(FemaleLeatherChest), 8);
				Add(typeof(FemaleStuddedChest), 15);
				Add(typeof(LeatherShorts), 8);
				Add(typeof(LeatherSkirt), 7);
				...
				Add(typeof(ChainChest), 31);
				Add(typeof(ChainLegs), 24);

				Add(typeof(RingmailArms), 12);
				Add(typeof(RingmailChest), 30);
				Add(typeof(RingmailGloves), 16);
				Add(typeof(RingmailLegs), 15);

				Add(typeof(BattleAxe), 13);
				Add(typeof(DoubleAxe), 16);
				Add(typeof(ExecutionersAxe), 12);
				Add(typeof(LargeBattleAxe), 13);
				Add(typeof(Pickaxe), 11);
				Add(typeof(TwoHandedAxe), 13);
				Add(typeof(WarAxe), 12);
				Add(typeof(Axe), 10);

				Add(typeof(Bardiche), 20);
				...
				Add(typeof(Mace), 7);
				Add(typeof(Maul), 7);
				Add(typeof(WarHammer), 7);
				Add(typeof(WarMace), 8);

				Add(typeof(HeavyCrossbow), 10);
				Add(typeof(Bow), 7);
				Add(typeof(Crossbow), 7);

				if (e >= Expansion.AOS)
				{
					Add(typeof(CompositeBow), 15);
				...
				Add(typeof(SmithHammerWeapon), 10);
