	...
	public class SBVagabond : SBInfo
	{
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( IronIngot ), 10, 20, 0x1BF2, 0 ) );

				Add( new GenericBuyInfo( typeof( StarSapphire ), 125, 20, 0xF21, 0 ) );
				Add( new GenericBuyInfo( typeof( Emerald ), 150, 20, 0xF10, 0 ) );
				Add( new GenericBuyInfo( typeof( Sapphire ), 150, 20, 0xF19, 0 ) );
				Add( new GenericBuyInfo( typeof( Ruby ), 100, 20, 0xF13, 0 ) );
				Add( new GenericBuyInfo( typeof( Citrine ), 75, 20, 0xF15, 0 ) );
				Add( new GenericBuyInfo( typeof( Amethyst ), 150, 20, 0xF16, 0 ) );
				Add( new GenericBuyInfo( typeof( Tourmaline ), 100, 20, 0xF2D, 0 ) );
				Add( new GenericBuyInfo( typeof( Amber ), 75, 20, 0xF25, 0 ) );
				Add( new GenericBuyInfo( typeof( Diamond ), 250, 20, 0xF26, 0 ) );
