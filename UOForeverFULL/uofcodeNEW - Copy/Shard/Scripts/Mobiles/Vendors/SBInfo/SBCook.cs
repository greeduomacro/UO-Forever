	...
	public class SBCook : SBInfo
	{
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
		{
			public InternalBuyInfo()
			{
				...
				//Add(new GenericBuyInfo(typeof(SackYeast), 3, 20, 0x1039, 650));
				//Add(new GenericBuyInfo(typeof(SackSugar), 3, 20, 0x1039, 996));
				Add(new GenericBuyInfo(typeof(JarHoney), 3, 20, 0x9EC, 0));
				//Add(new GenericBuyInfo(typeof(JarSyrup), 3, 20, 0x9EC, 0));
		...
		public class InternalSellInfo : GenericSellInfo
		{
			...
			{
				Add(typeof(CheeseWheel), 6);
				Add(typeof(CookedBird), 4);
				Add(typeof(RoastPig), 8);
				Add(typeof(Cake), 3);
