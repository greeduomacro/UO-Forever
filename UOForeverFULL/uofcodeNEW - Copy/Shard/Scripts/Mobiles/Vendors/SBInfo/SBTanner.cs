	...
	public class SBTanner : SBInfo
	{
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( Leather ), 9, 20, 0x1081, 0 ) );
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add( typeof( LeatherArms ), 8 );
				Add( typeof( LeatherChest ), 10 );
				Add( typeof( LeatherGloves ), 9 );
				Add( typeof( LeatherGorget ), 9 );
				Add( typeof( LeatherLegs ), 9 );
				Add( typeof( LeatherCap ), 5 );

				Add( typeof( StuddedArms ), 13 );
				Add( typeof( StuddedChest ), 17 );
				Add( typeof( StuddedGloves ), 9 );
				Add( typeof( StuddedGorget ), 6 );
				Add( typeof( StuddedLegs ), 6 );

				Add( typeof( FemaleStuddedChest ), 13 );
				Add( typeof( StuddedBustierArms ), 8 );
				Add( typeof( FemalePlateChest), 33 );
				Add( typeof( FemaleLeatherChest ), 15 );
				Add( typeof( LeatherBustierArms ), 12 );
				Add( typeof( LeatherShorts ), 7 );
				Add( typeof( LeatherSkirt ), 9 );
			}
		}
	}
}