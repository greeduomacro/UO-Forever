	...
	public class SBCarpenter: SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add( typeof( LargeTable ), 7 );
				Add( typeof( Nightstand ), 5 );
				Add( typeof( YewWoodTable ), 7 );
				...
				Add( typeof( FancyWoodenChairCushion ), 9 );
				...
				Add( typeof( Lute ), 8 );
				Add( typeof( LapHarp ), 8 );
				Add( typeof( Tambourine ), 8 );
				Add( typeof( Drums ), 8 );
