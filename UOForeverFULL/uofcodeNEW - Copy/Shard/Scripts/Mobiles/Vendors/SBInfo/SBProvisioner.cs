	...
	public class SBProvisioner : SBInfo
	{
		...
		public class InternalBuyInfo : List<IBuyItemInfo>
		{
			public InternalBuyInfo(Expansion e)
			{
				...
				Add(new GenericBuyInfo(typeof(TPouch), 20, 999, 0xE79, 38));
				...
				Add(new GenericBuyInfo("1041205", typeof(SmallBoatDeed), 100177, 20, 0x14F2, 0));
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				Add(typeof(LeatherCap), 3);
				Add(typeof(FeatheredHat), 3);
