...
namespace Server.Mobiles
{
	public class Weaponsmith : BaseVendor
	{
		...
		{
			m_SBInfos.Add( new SBWeaponSmith(Expansion) );
		...
		public override bool SupportsBulkOrders( Mobile from )
		{
			...
			return ( FactionAllegiance == null || fact == null || FactionAllegiance == fact ) && ( from is PlayerMobile && from.Skills[SkillName.Blacksmith].Base > 55.0 );
		}
