	...
	public class HealerAI : BaseAI
	{
		...
		public override bool Think()
		{
			...
			else
			{
				...
				{
                    if (AcquireFocusMob(m_Mobile.RangePerception, FightMode.Weakest, m_Mobile.IsScaryToPets, true, false))
					{
		...
		{
			return m.Hits < (int)(m.HitsMax * 0.60);
		}

		private static bool NeedLHeal( Mobile m )
		{
			return m.Hits < (int)(m.HitsMax * 0.90);
		}
	}
}