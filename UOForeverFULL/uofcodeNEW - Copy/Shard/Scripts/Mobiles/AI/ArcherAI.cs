...
namespace Server.Mobiles
{
	public class ArcherAI : BaseAI
	{
		...
		public override bool DoActionWander()
		{
            ...
            else if (m_Mobile.ForceWaypoint && (m_Mobile.CurrentWayPoint != null || m_Mobile.TargetLocation != null))
            {
                m_Mobile.CurrentSpeed = m_Mobile.ActiveSpeed;
                base.DoActionWander();
            }
		...
		public override bool DoActionCombat()
		{
			...
			if ( (m_Mobile.LastMoveTime + TimeSpan.FromSeconds( 1.0 )) < DateTime.UtcNow )
			{
				if (WalkMobileRange(m_Mobile.Combatant, 1, true, m_Mobile.RangeFight, m_Mobile.Weapon.MaxRange))
				{
                    ...
                    //  this line is why mobs "float" all the time... kind of makes sense for archers
