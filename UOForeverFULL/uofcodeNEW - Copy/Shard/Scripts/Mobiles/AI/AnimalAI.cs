...
namespace Server.Mobiles
{
	public class AnimalAI : BaseAI
	{
		...
		public override bool DoActionWander()
		{
            ...
            else if ( !m_Mobile.Summoned && !m_Mobile.Controlled && hitPercent < 0.1 && m_Mobile.CanFlee ) // Less than 10% health
			{
		...
		public override bool DoActionCombat()
		{
			...
			{
                //  this line is why mobs "float" all the time... so I commented out.  Can't see why it's necessary
		...
		public override bool DoActionBackoff()
		{
            ...
            if (m_Mobile.ForceWaypoint && (m_Mobile.CurrentWayPoint != null || m_Mobile.TargetLocation != null))
            {
                m_Mobile.DebugSay("I'm backing off but must go to my waypoint!");
                Action = ActionType.Wander;
                return true;
            }
		...
		public override bool DoActionFlee()
		{
            if (m_Mobile.ForceWaypoint && (m_Mobile.CurrentWayPoint != null || m_Mobile.TargetLocation != null))
            {
                m_Mobile.DebugSay("I'm in fleeing but must go to my waypoint!");
                Action = ActionType.Wander;
                return true;
            }
