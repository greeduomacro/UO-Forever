...
namespace Server.Engines.MyRunUO
{
	public class LayerComparer : IComparer<Item>
	{
		...
		private static readonly Layer[] m_DesiredLayerOrder =
		{
			Layer.Cloak, Layer.Bracelet, Layer.Ring, Layer.Shirt,
			Layer.Pants, Layer.InnerLegs, Layer.Shoes, LeatherShorts, Layer.Arms, Layer.InnerTorso, LeatherShorts, PlateArms,
			Layer.MiddleTorso, Layer.OuterLegs, Layer.Neck, Layer.Waist, Layer.Gloves, Layer.OuterTorso, Layer.OneHanded,
