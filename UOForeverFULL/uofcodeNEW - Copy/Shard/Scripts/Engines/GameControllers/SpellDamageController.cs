...
{
    class SpellDamageController : Item
    {   
        private static SpellDamageController m_Instance;
        public static SpellDamageController Instance { get { return m_Instance; } }

        [Constructable]
        public SpellDamageController()
            : base(0xEDC)
        {
            this.Name = "Spell Damage Controller";
            this.Movable = false;
            this.Visible = false;
            ...
            if (m_Instance != null)
            {
                ...
                Timer.DelayCall(TimeSpan.FromSeconds(1), new TimerStateCallback<SpellDamageController>(UpdateInstancePosition), this); 
            }
            else
                m_Instance = this;
        }

        public static void UpdateInstancePosition(SpellDamageController attemptedConstruct)
        {
        ...
        public SpellDamageController(Serial serial) : base(serial) { }
