...
namespace Server.Engines.Help
{
	...
	public class HelpGump : Gump
	{
		...
		{
			return m.Aggressed.Any(info => DateTime.UtcNow - info.LastCombatTime < TimeSpan.FromSeconds(30.0));
		}
			...
			: base(0, 0)
		{
			...
			AddHtml(150, 50, 360, 40, "<CENTER><U>Ultima Online Forever Help Menu</U></CENTER>", false, false);
			...
			if (isYoung)
			{
				...
				AddHtml(
					...
					450,
					58,
					@"<BODY><BASEFONT COLOR=BLACK><u>Young Player Transport.</u> Select this option if you want to be transported to Safety.</BODY>",
					true,
					true);
				...
				AddHtml(
					...
					450,
					58,
					@"<u>General question about Ultima Online Forever.</u> Select this option if you have a general gameplay question, most you can find the answer too on our forum http://www.uoforum.com.",
					true,
					true);
				...
				AddHtml(
					...
					450,
					58,
					@"<u>My character is physically stuck in the game.</u> This choice only covers cases where your character is physically stuck in a location they cannot move out of. This option will only work two times in 24 hours. DO NOT PAGE IN ASKING FOR US TO MOVE YOU IF YOU ARE NOT STUCK THIS IS NOT A TAXI SERVICE!",
					true,
					true);
				...
				AddHtml(
					...
					450,
					58,
					@"<u>Another player is harassing me.</u> Another player is verbally harassing your character. When you select this option you will be sending a text log to UOFOREVER. To see what constitutes harassment please visit http://uoforever.com/rules.php.",
					true,
					true);
				...
				AddHtml(
					...
					450,
					58,
					@"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the website/forum (located at http://www.uoforum.com), please use this option.",
					true,
					true);
			}
			else
			...
			AddHtml(
				...
				450,
				74,
				@"<u>Report a bug or contact UOForever Staff.</u> Use this option to report a bug. You may also choose to report bugs to our bug report section on our forum. ",
				true,
				true);
			...
			AddHtml(
				...
				450,
				74,
				@"<u>Suggestion for the Game.</u> All Suggestions should be reported to our forum at http://www.uoforum.com. ",
				true,
				true);
			...
			AddHtml(
				...
				450,
				74,
				@"<u>Account Issues</u> For questions regarding your account such as forgotten passwords, house issues, account issues, please choose this option.",
				true,
				true);
			...
			string html = String.Join(
				...
				new[]
				{
					...
					"Use this option when another player is verbally harassing your character on a PERSONAL level.", //
					"Verbal harassment behaviors include but are not limited to, using real life threats and racism.", //
					"Before you submit a complaint BE SURE you understand what constitutes harassment", //
					"<A HREF=\"http://uoforever.com/rules.php\">– what is verbal harassment? -</A>", //
					...
					"<A HREF=\"http://uoforum.com/ignore.png\">- How do I ignore a player?</A><BR>", //
					"5. You have read and understand UOForever’s definition of harassment.<BR>", //
					...
					"Abuse of this system is a violation of the Rules of Conduct and will result in punishment.<BR>", //
					"EXPLOITING / CHEATING<BR>", "Use this option to report someone who may be exploiting or cheating.", //
					"<A HREF=\"http://uoforum.com/threads/4957/\">– What constitutes an exploit?</a>"
				});
			AddHtml(110, 90, 450, 145, html, true, true);
			...
			html = String.Join(
				...
				new[]
				{
					...
					"Physical harassment includes but is not limited to luring, ghost trapping, ghost camping.", //
					"Before you submit a complaint be sure you understand what constitutes harassment", //
					"<A HREF=\"http://uoforever.com/rules.php\"> – what is physical harassment?</A>", //
					"and that you have followed these steps:<BR>", //
					"1. You have asked the player to stop and they have continued.<BR>", //
					"2. You have tried to remove yourself from the situation.<BR>", //
					"3. You have done nothing to instigate or further encourage the harassment.<BR>", //
					...
					"Abuse of this system is a violation of the Rules of Conduct and will result in punishment."
				});
			AddHtml(110, 240, 450, 145, html, true, true);

			AddButton(150, 390, 5540, 5541, 0, GumpButtonType.Page, 1);
			AddHtml(180, 390, 335, 40, "NO  - I meant to ask for help with another matter.", false, false);
		}
