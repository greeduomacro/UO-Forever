...
namespace Server.Engines.ConPVP
{
	...
	{
		private List<PreferencesEntry> m_Entries;
		private Dictionary<Mobile, PreferencesEntry> m_Table;

		public List<PreferencesEntry> Entries{ get{ return m_Entries; } }
		...
		public Preferences()
		{
			...
			m_Entries = new List<PreferencesEntry>();
		}
	...
	public class PreferencesEntry
	{
		...
		private List<string> m_Disliked;
		private Preferences m_Preferences;

		public Mobile Mobile{ get{ return m_Mobile; } }
		public List<string> Disliked{ get{ return m_Disliked; } }
		...
		public PreferencesEntry( GenericReader reader, Preferences prefs, int version )
		{
			...
			switch ( version )
			{
				case 0:
				{
					...
					m_Disliked = new List<string>( count );
