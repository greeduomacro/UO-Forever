...
namespace Server.Engines.ConPVP
{
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
                ...
                m.CanBeginAction(this))
            {
                ...
                PrivateOverheadMessage(MessageType.Regular, 0x35, false,
                    String.Format(
                        "Hello m'{0}. Dost thou wish to enter this tournament? You need only to write your name in this book.",
                        m.Female ? "Lady" : "Lord"), m.NetState);
                m.BeginAction(this);
    ...
    public class TournamentSignupItem : Item
    {
        ...
        public override string DefaultName { get { return "tournament signup book"; } }
                        ...
                        case TournamentStage.Signup:
                        {
                            ...
                            if (ladder != null)
                            {
                                ...
                                if (entry != null && Ladder.GetLevel(entry.Experience) < tourny.LevelRequirement)
                                {
                                    ...
                                    {
                                        m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                                            0x35, false, "You have not yet proven yourself a worthy dueler.",
                                            from.NetState);
                                    }
                            ...
                            if (from.HasGump(typeof(AcceptTeamGump)))
                            {
                                ...
                                {
                                    m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                                        0x22, false, "You must first respond to the offer I've given you.",
                                        from.NetState);
                                }
                            }
    ...
    public class ConfirmSignupGump : Gump
    {
        ...
        public ConfirmSignupGump(Mobile from, Mobile registrar, Tournament tourny, List<Mobile> players) : base(50, 50)
        {
            m_From = from;
            ...
            AddBorderedText(22, 50, 294, 40, "You have been invited to join the tournament. Do you accept the rules?",
            ...
            {
                AddBorderedText(35, y, 190, 20, String.Format(" + {0}", ((Ruleset) ruleset.Flavors[i]).Title),
                    LabelColor32, BlackColor32);
            }
                    ...
                    case TournamentStage.Signup:
                    {
                            ...
                            if (entry != null && Ladder.GetLevel(entry.Experience) < tourny.LevelRequirement)
                            {
                                if (m_Registrar != null)
                                {
                                    ...
                                    else
                                    {
                                        m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                                            0x35, false,
                                            String.Format("{0} has not yet proven themselves a worthy dueler.", mob.Name),
                                            from.NetState);
                                    }
                                }
                            ...
                            else if (tourny.HasParticipant(mob))
                            {
                                if (m_Registrar != null)
                                {
                                    ...
                                    else
                                    {
                                        m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                                            0x35, false,
                                            String.Format("{0} has already entered this tournament.", mob.Name),
                                            from.NetState);
                                    }
                                }
                                ...
                                if (m_Registrar != null)
                                {
                                    ...
                                    else
                                    {
                                        m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                                            0x35, false,
                                            String.Format(
                                                "{0} is already assigned to a duel. They must yield it before joining this tournament.",
                                                mob.Name), from.NetState);
                                    }
                                }
                        ...
                        if (m_Registrar != null)
                        {
                            ...
                            var minutesUntil =
                                (int)
                                    Math.Round(
                                        ((tourny.SignupStart + tourny.SignupPeriod) - DateTime.UtcNow).TotalMinutes);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (m_Registrar != null)
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                            0x59, false,
                            String.Format("As you command m'{0}. I've given your offer to {1}.",
                                from.Female ? "Lady" : "Lord", mob.Name), from.NetState);
                    }
                }
            }
        }
    ...
    public class AcceptTeamGump : Gump
    {
        ...
        public AcceptTeamGump(Mobile from, Mobile requested, Tournament tourny, Mobile registrar, List<Mobile> players)
            : base(50, 50)
        {
            m_From = from;
        ...
        public void AutoReject()
        {
            ...
            if (m_Registrar != null)
            {
                ...
                m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                    0x22, false, String.Format("You have declined the partnership with {0}.", m_From.Name),
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (info.IsSwitched(1))
            {
                ...
                else
                {
                    ...
                    {
                        m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                            0x59, false, String.Format("{0} has accepted your offer of partnership.", mob.Name),
                            from.NetState);

                        m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                            0x59, false, String.Format("You have accepted the partnership with {0}.", from.Name),
                            mob.NetState);
                    }
                }
            }
            else
            {
                ...
                {
                    m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                        0x22, false, String.Format("{0} has declined your offer of partnership.", mob.Name),
                        from.NetState);

                    m_Registrar.PrivateOverheadMessage(MessageType.Regular,
                        0x22, false, String.Format("You have declined the partnership with {0}.", from.Name),
                        mob.NetState);
                }
            }
        }
    ...
    public class TournamentController : Item
    {
        ...
        public override string DefaultName { get { return "tournament controller"; } }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            if (from.AccessLevel >= AccessLevel.EventMaster && m_Tournament != null)
            {
        ...
        private class StartEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                {
                    if (m_Tournament.PlayersPerParticipant == 1)
                    {
                        foreach (var ns in
                            NetState.Instances)
                        {
                            var profile = CentralGump.CentralGump.EnsureProfile(ns.Mobile as PlayerMobile);
                            var pm = ns.Mobile as PlayerMobile;
                            if (pm != null && !profile.IgnoreTournament && pm.PokerGame == null)
                            {
                                var players = new List<Mobile>();
                                players.Add(ns.Mobile);
                                ns.Mobile.CloseGump(typeof(ConfirmSignupGump));
                                ns.Mobile.SendGump(new ConfirmSignupGump(ns.Mobile, null, m_Tournament, players));
                            }
                        }
                    }
    ...
    public class Tournament
    {
        ...
        private List<TournyParticipant> m_Participants;
        private List<TournyParticipant> m_Undefeated;
        ...
        [CommandProperty(AccessLevel.EventMaster)]
        public EventController EventController { get { return m_EventController; } set { m_EventController = value; } }

        [CommandProperty(AccessLevel.EventMaster)]
        public int SuddenDeathRounds { get { return m_SuddenDeathRounds; } set { m_SuddenDeathRounds = value; } }


        [CommandProperty(AccessLevel.EventMaster)]
        public TournyType TournyType { get { return m_TournyType; } set { m_TournyType = value; } }

        [CommandProperty(AccessLevel.EventMaster)]
        public GroupingType GroupType { get { return m_GroupType; } set { m_GroupType = value; } }

        [CommandProperty(AccessLevel.EventMaster)]
        public TieType TieType { get { return m_TieType; } set { m_TieType = value; } }

        [CommandProperty(AccessLevel.EventMaster)]
        public TimeSpan SuddenDeath { get { return m_SuddenDeath; } set { m_SuddenDeath = value; } }

        public Ruleset Ruleset { get { return m_Ruleset; } set { m_Ruleset = value; } }
        ...
        [CommandProperty(AccessLevel.EventMaster)]
        public TimeSpan SignupPeriod { get { return m_SignupPeriod; } set { m_SignupPeriod = value; } }

        [CommandProperty(AccessLevel.EventMaster)]
        public DateTime SignupStart { get { return m_SignupStart; } set { m_SignupStart = value; } }

        [CommandProperty(AccessLevel.EventMaster)]
        public TournamentStage CurrentStage { get { return m_Stage; } }

        public TournamentStage Stage { get { return m_Stage; } set { m_Stage = value; } }

        public TournyPyramid Pyramid { get { return m_Pyramid; } set { m_Pyramid = value; } }

        public List<Arena> Arenas { get { return m_Arenas; } set { m_Arenas = value; } }

        public List<TournyParticipant> Participants { get { return m_Participants; } set { m_Participants = value; } }

        public List<TournyParticipant> Undefeated { get { return m_Undefeated; } set { m_Undefeated = value; } }

        public bool HasParticipant(Mobile mob)
        {
            for (int i = 0; i < m_Participants.Count; ++i)
            {
                TournyParticipant part = m_Participants[i];
        ...
        public Tournament(GenericReader reader)
        {
            ...
            switch (version)
            {
                ...
                case 0:
                {
                    ...
                    m_Participants = new List<TournyParticipant>();
                    m_Undefeated = new List<TournyParticipant>();
                    m_Arenas = new List<Arena>();
        ...
        public void HandleTie(Arena arena, TournyMatch match, List<TournyParticipant> remaining)
        {
            ...
            {
                TournyParticipant part = match.Participants[j];
            ...
            switch (m_TieType)
            {
                ...
                case TieType.Random:
                {
                    TournyParticipant advanced = remaining[Utility.Random(remaining.Count)];
                ...
                case TieType.Highest:
                {
                    ...
                    for (int i = 0; i < remaining.Count; ++i)
                    {
                        TournyParticipant part = remaining[i];
        ...
        {
            if (PseudoSeerStone.Instance.TournamentAward > 0)
            {
                return PseudoSeerStone.Instance.TournamentAward;
            }
            else
            {
                return 1000;
        ...
        private void GiveAwards()
        {
            switch (m_TournyType)
            {
                ...
                case TournyType.Standard:
                {
                    ...
                    {
                        TournyParticipant part = match.Participants[i];
        ...
        public void Slice()
        {
            ...
            else if (m_Stage == TournamentStage.Fighting)
            {
                ...
                {
                    TournyParticipant winner = m_Undefeated[0];
                    ...
                    try
                    {
                        if (m_EventController != null)
                        {
                            Alert("The tournament has completed!",
                                String.Format("Team {0} has won!",
                                    m_EventController.GetTeamName(
                                        ((TournyMatch) ((PyramidLevel) m_Pyramid.Levels[0]).Matches[0]).Participants
                                            .IndexOf(winner))));
                        }
                        else if (m_TournyType == TournyType.RandomTeam)
                        {
                            Alert("The tournament has completed!",
                                String.Format("Team {0} has won!",
                                    ((TournyMatch) ((PyramidLevel) m_Pyramid.Levels[0]).Matches[0]).Participants.IndexOf
                                        (winner) + 1));
                        }
                        else if (m_TournyType == TournyType.RedVsBlue)
                        {
                        ...
                        {
                            Alert("The tournament has completed!",
                                String.Format("{0} {1} the champion{2}.", winner.NameList,
                                    winner.Players.Count > 1 ? "are" : "is", winner.Players.Count == 1 ? "" : "s"));
                        }
                    }
                    catch
                    {}
                    ...
                    /*foreach (var tournyParticipant in Participants)
                    {
                        foreach (var mobile in tournyParticipant.Players)
                        {
                            var player = mobile as PlayerMobile;

                            if (player != null)
                            {
                                string name = tournyParticipant.Players.Count + " vs " + tournyParticipant.Players.Count +
                                              " Tournament";
                                var eventprofile = EventScores.EventScores.EnsureProfile(player);
                                eventprofile.AddTournament(name, tournyParticipant.Points, player);
                            }
                        }
                    }*/
                ...
                else if (m_Pyramid.Levels.Count > 0)
                {
                    ...
                    if (!stillGoing)
                    {
                        ...
                        {
                            TournyParticipant part = m_Undefeated[i];
                            bool bad = false;
                            ...
                            if (bad)
                            {
                                for (int j = 0; j < part.Players.Count; ++j)
                                {
                                    ((Mobile) part.Players[j]).SendMessage(
                                    ...
                                    try
                                    {
                                        if (m_EventController != null)
                                        {
                                            Alert("The tournament has completed!",
                                                String.Format("Team {0} has won",
                                                    m_EventController.GetTeamName(
                                                        ((TournyMatch) ((PyramidLevel) m_Pyramid.Levels[0]).Matches[0])
                                        ...
                                        else
                                        {
                                            Alert("The tournament has completed!",
                                                String.Format("{0} {1} the champion{2}.", winner.NameList,
                                                    winner.Players.Count > 1 ? "are" : "is",
                                                    winner.Players.Count == 1 ? "" : "s"));
                                        }
                                    }
                                    catch
                                    {}
    ...
    {
        private List<PyramidLevel> m_Levels;

        public List<PyramidLevel> Levels { get { return m_Levels; } set { m_Levels = value; } }

        public TournyPyramid()
        {
            m_Levels = new List<PyramidLevel>();
        }
    ...
    {
        public List<TournyMatch> Matches { get; set; }

        public TournyParticipant FreeAdvance { get; set; }

        public PyramidLevel()
        {
            Matches = new List<TournyMatch>();
        }
    }
    ...
    public class TournyMatch
    {
        ...
        public DuelContext Context { get { return m_Context; } set { m_Context = value; } }

        public bool InProgress { get { return (m_Context != null && m_Context.Registered); } }

        public void Start(Arena arena, Tournament tourny)
        {
            TournyParticipant first = m_Participants[0];

            var dc = new DuelContext(first.Players[0], tourny.Ruleset.Layout, false);
            dc.Ruleset.Options.SetAll(false);
            dc.Ruleset.Options.Or(tourny.Ruleset.Options);

            for (int i = 0; i < m_Participants.Count; ++i)
            {
                TournyParticipant tournyPart = m_Participants[i];
                ...
                {
                    duelPart.Add(tournyPart.Players[j]);
                }
            ...
            if (dc.StartedBeginCountdown)
            {
                ...
                for (int i = 0; i < m_Participants.Count; ++i)
                {
                    TournyParticipant p = m_Participants[i];
        ...
        public TournyMatch(List<TournyParticipant> participants)
        {
            m_Participants = participants;

            for (int i = 0; i < participants.Count; ++i)
            {
                TournyParticipant part = participants[i];
    ...
    public class TournyParticipant : IComparable
    {
        ...
        public List<Mobile> Players { get { return m_Players; } set { m_Players = value; } }
        ...
        public TournyParticipant(List<Mobile> players)
        {
            m_Log = new List<string>();
            m_Players = players;
        }
    ...
    public class TournamentBracketGump : Gump
    {
        ...
        public TournamentBracketGump(Mobile from, Tournament tourny, TournyBracketGumpType type, ArrayList list,
            int page, object obj) : base(50, 50)
        {
            m_From = from;
            m_Tournament = tourny;
            m_Type = type;
            ...
            switch (type)
            {
                case TournyBracketGumpType.Index:
                {
                    ...
                    if (m_Tournament.Stage == TournamentStage.Signup)
                    {
                        ...
                        if (secs > 0)
                        {
                            ...
                            if (mins > 0 && secs > 0)
                            {
                                text = String.Format("The tournament will begin in {0} minute{1} and {2} second{3}.",
                                    mins, mins == 1 ? "" : "s", secs, secs == 1 ? "" : "s");
                            }
                            else if (mins > 0)
                            {
                                text = String.Format("The tournament will begin in {0} minute{1}.", mins,
                                    mins == 1 ? "" : "s");
                            }
                            else if (secs > 0)
                            {
                                text = String.Format("The tournament will begin in {0} second{1}.", secs,
                                    secs == 1 ? "" : "s");
                            }
                            else
                            {
                ...
                case TournyBracketGumpType.Rules_Info:
                {
                    ...
                    if (tourny.SuddenDeath > TimeSpan.Zero)
                    {
                        sdText = String.Format("{0}:{1:D2}", (int) tourny.SuddenDeath.TotalMinutes,
                            tourny.SuddenDeath.Seconds);
                    ...
                    for (int i = 0; i < ruleset.Flavors.Count; ++i, y += 18)
                    {
                        AddHtml(35, y, 190, 20, String.Format(" + {0}", ((Ruleset) ruleset.Flavors[i]).Title), false,
                            false);
                    }
                ...
                case TournyBracketGumpType.Participant_List:
                {
                    ...
                    AddLeftArrow(25, 11, ToButtonID(0, 0));
                    AddHtml(25, 35, 250, 20,
                        Center(String.Format("{0} Participant{1}", m_List.Count, m_List.Count == 1 ? "" : "s")), false,
                        false);
                ...
                case TournyBracketGumpType.Participant_Info:
                {
                    ...
                    AddHtml(25, y, 200, 20,
                        String.Format("Free Advances: {0}",
                            part.FreeAdvances == 0 ? "None" : part.FreeAdvances.ToString()), false, false);
                    y += 20;
                ...
                case TournyBracketGumpType.Player_Info:
                {
                    ...
                    AddHtml(25, 73, 250, 20,
                        String.Format("Guild: {0}",
                            mob.Guild == null ? "None" : mob.Guild.Name + " [" + mob.Guild.Abbreviation + "]"), false,
                        false);
                    AddHtml(25, 93, 250, 20,
                        String.Format("Rank: {0}", entry == null ? "N/A" : LadderGump.Rank(entry.Index + 1)), false,
                        false);
                    AddHtml(25, 113, 250, 20,
                        String.Format("Level: {0}", entry == null ? 0 : Ladder.GetLevel(entry.Experience)), false, false);
                    AddHtml(25, 133, 250, 20, String.Format("Wins: {0:N0}", entry == null ? 0 : entry.Wins), false,
                        false);
                    AddHtml(25, 153, 250, 20, String.Format("Losses: {0:N0}", entry == null ? 0 : entry.Losses), false,
                        false);
                ...
                case TournyBracketGumpType.Round_Info:
                {
                    ...
                    AddRightArrow(25, 53, ToButtonID(5, 0),
                        String.Format("Free Advance: {0}",
                            level.FreeAdvance == null ? "None" : level.FreeAdvance.NameList));

                    AddHtml(25, 73, 200, 20, String.Format("{0} Match{1}", m_List.Count, m_List.Count == 1 ? "" : "es"),
                        false, false);
                    ...
                    for (int i = 0; i < count; ++i, y += 18)
                    {
                        ...
                        else if (m_Tournament.EventController != null || m_Tournament.TournyType == TournyType.RandomTeam ||
                                 m_Tournament.TournyType == TournyType.RedVsBlue)
                        {
                            for (int j = 0; j < match.Participants.Count; ++j)
                            {
                                if (sb.Length > 0)
                                ...
                                {
                                    txt = String.Format("Team {0} ({1})",
                                        m_Tournament.EventController.GetTeamName(j), part.Players.Count);
                                }
                                ...
                                {
                                    txt = String.Format("Team {0} ({1})", j == 0 ? "Red" : "Blue",
                                        part.Players.Count);
                                }
                ...
                case TournyBracketGumpType.Match_Info:
                {
                    ...
                    AddHtml(25, 53, 250, 20,
                        String.Format("Winner: {0}", match.Winner == null ? "N/A" : match.Winner.NameList), false, false);
                    AddHtml(25, 73, 250, 20,
                        String.Format("State: {0}",
                            match.InProgress ? "In progress" : match.Context != null ? "Complete" : "Waiting"), false,
                        false);
                        ...
                        for (int i = 0; i < match.Participants.Count; ++i)
                        {
                            ...
                            if (m_Tournament.EventController != null)
                            {
                                AddRightArrow(25, 113 + (i * 18), ToButtonID(6, i),
                                    String.Format("Team {0} ({1})", m_Tournament.EventController.GetTeamName(i),
                                        part.Players.Count));
                            }
                            else if (m_Tournament.TournyType == TournyType.RandomTeam)
                            {
                                AddRightArrow(25, 113 + (i * 18), ToButtonID(6, i),
                                    String.Format("Team {0} ({1})", i + 1, part.Players.Count));
                            }
                            else
                            {
                                AddRightArrow(25, 113 + (i * 18), ToButtonID(6, i),
                                    String.Format("Team {0} ({1})", i == 0 ? "Red" : "Blue", part.Players.Count));
                            }
                        }
                    }
                    else if (m_Tournament.TournyType == TournyType.FreeForAll)
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (type)
            {
                case 0:
                {
                    ...
                    {
                        case 0:
                            m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Index,
                                null, 0, null));
                            break;
                        case 1:
                            m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                                TournyBracketGumpType.Participant_List, null, 0, null));
                            break;
                        case 2:
                            m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                                TournyBracketGumpType.Round_List, null, 0, null));
                            break;
                        case 4:
                            m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                                TournyBracketGumpType.Rules_Info, null, 0, null));
                            break;
                        case 3:
                        {
                            ...
                            {
                                TournyParticipant part = m_Tournament.Participants[i];

                                if (part.Players.Contains(mob))
                                {
                                    m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                                        TournyBracketGumpType.Participant_Info, null, 0, part));
                                    break;
                                }
                            }
                        ...
                        case 5:
                        {
                            ...
                            for (int i = 0; i < m_Tournament.Pyramid.Levels.Count; ++i)
                            {
                                ...
                                {
                                    m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                                        TournyBracketGumpType.Round_Info, null, 0, level));
                                }
                            }
                ...
                case 1:
                {
                    switch (index)
                    {
                        case 0:
                        {
                            ...
                            {
                                m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, m_Type, m_List,
                                    m_Page - 1, m_Object));
                            }
                ...
                case 2:
                {
                    ...
                    {
                        m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                            TournyBracketGumpType.Participant_Info, null, 0, m_List[index]));
                    }
                ...
                case 3:
                {
                    ...
                    if (index >= 0 && index < m_List.Count)
                    {
                        m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Round_Info,
                            null, 0, m_List[index]));
                    }
                ...
                case 4:
                {
                    ...
                    {
                        m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                            TournyBracketGumpType.Player_Info, null, 0, part.Players[index]));
                    }
                ...
                case 5:
                {
                    ...
                    if (index == 0)
                    {
                        ...
                        {
                            m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                                TournyBracketGumpType.Participant_Info, null, 0, level.FreeAdvance));
                        }
                        else
                        {
                            m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, m_Type, m_List, m_Page,
                                m_Object));
                        }
                    }
                    else if (index >= 1 && index <= level.Matches.Count)
                    {
                        m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament, TournyBracketGumpType.Match_Info,
                ...
                case 6:
                {
                    ...
                    {
                        m_From.SendGump(new TournamentBracketGump(m_From, m_Tournament,
                            TournyBracketGumpType.Participant_Info, null, 0, match.Participants[index]));
                    }
    ...
    public class TournamentBracketItem : Item
    {
        ...
        public override string DefaultName { get { return "tournament bracket"; } }
