...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
		...
		public static CraftSystem CraftSystem { get { return m_CraftSystem ?? (m_CraftSystem = new DefTinkering()); } }
		...
		private static readonly Type[] m_TinkerColorables = new[]
		{
			typeof(ForkLeft), typeof(ForkRight), typeof(SpoonLeft), typeof(SpoonRight), typeof(KnifeLeft), typeof(KnifeRight),
			typeof(Plate), typeof(Goblet), typeof(PewterMug), typeof(KeyRing), typeof(Candelabra), typeof(Scales), typeof(Key),
			typeof(Globe), typeof(Spyglass), typeof(Lantern), typeof(HeatingStand)
		};
		...
		public void AddJewelrySet(GemType gemType, Type itemType)
		{
			...
			index = AddCraft(
				typeof(SilverBeadNecklace), 1044049, 1044185 + offset, 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
			AddRes(index, itemType, 1044231 + offset, 1, 1044240);
			...
			index = AddCraft(
				typeof(GoldBeadNecklace), 1044049, 1044212 + offset, 40.0, 90.0, typeof(IronIngot), 1044036, 2, 1044037);
			AddRes(index, itemType, 1044231 + offset, 1, 1044240);
		...
		public override void InitCraftList()
		{
			...
			AddCraft(typeof(SmithHammerWeapon), 1044046, 1025091, 40.0, 90.0, typeof(IronIngot), 1044036, 4, 1044037);
			...
			index = AddCraft(
				typeof(FactionExplosionTrapDeed), 1044052, 1044599, 65.0, 115.0, typeof(Silver), 1044572, 1000, 1044253);
			AddRes(index, typeof(IronIngot), 1044036, 10, 1044037);
			AddRes(index, typeof(BaseExplosionPotion), 1044569, 1, 1044253);
	...
	public abstract class TrapCraft : CustomCraft
	{
		...
		public TrapCraft(Mobile from, CraftItem craftItem, CraftSystem craftSystem, Type typeRes, IBaseTool tool, int quality)
		...
		public override Item CompleteCraft(out int message)
		{
			...
			if (message == 0)
			{
				...
				Container.TrapPower = trapLevel * 7;
