...
namespace Server.Engines.Craft
{
	public class DefCooking : CraftSystem
	{
		...
		public static CraftSystem CraftSystem { get { return m_CraftSystem ?? (m_CraftSystem = new DefCooking()); } }
		...
		public override void InitCraftList()
		{
			...
			index = AddCraft(
				typeof(SackBarley), 1044495, "sack of barley", 0.0, 100.0, typeof(BarleySheaf), "barley sheaf", 2, 1044490);
			SetNeedMill(index, true);

			index = AddCraft(
				typeof(SackSugar), 1044495, "sack of sugar", 0.0, 100.0, typeof(SugarcaneSheaf), "sugarcane sheaf", 2, 1044490);
			SetNeedMill(index, true);

			index = AddCraft(typeof(SackYeast), 1044495, "sack of yeast", 0.0, 100.0, typeof(BaseBeverage), 1046458, 1, 1044490);
			AddRes(index, typeof(Apple), "apple", 2, 1044490);
			AddRes(index, typeof(Grapes), "grapes", 2, 1044490);
			AddRes(index, typeof(Peach), "peach", 2, 1044490);
			SetNeedHeat(index, true);

			index = AddCraft(typeof(JarSyrup), 1044495, "jar of syrup", 0.0, 100.0, typeof(JarHoney), 1044472, 1, 1044490);
			AddRes(index, typeof(SackSugar), "sugar", 2, 1044253);
			SetNeedHeat(index, true);
			...
			AddRes(index, typeof(SackYeast), "yeast", 1, 1044253);
			...
			index = AddCraft(typeof(TribalPaint), 1044496, 1040000, 80.0, 120.0, typeof(SackFlour), 1044468, 1, 1044253);
			...
			index = AddCraft(
				typeof(SausagePizza), 1044497, 1044517, 0.0, 100.0, typeof(UncookedSausagePizza), 1044520, 1, 1044253);
			SetNeedOven(index, true);
			...
			index = AddCraft(
				typeof(PeachCobbler), 1044497, 1041344, 0.0, 100.0, typeof(UnbakedPeachCobbler), 1044523, 1, 1044253);
			SetNeedOven(index, true);
