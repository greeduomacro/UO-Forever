...
namespace Server.Engines.Craft
{
	...
	public class Resmelt
	{
		...
		private class InternalTarget : Target
		{
			...
			public InternalTarget( CraftSystem craftSystem, IBaseTool tool ) :  base ( 2, false, TargetFlags.None )
			{
			...
			private SmeltResult Resmelt( Mobile from, Item item, CraftResource resource )
			{
				try
				{
					...
					Conquests.Conquests.CheckProgress<ItemConquest>(from as PlayerMobile, ingot, "resmelt");
