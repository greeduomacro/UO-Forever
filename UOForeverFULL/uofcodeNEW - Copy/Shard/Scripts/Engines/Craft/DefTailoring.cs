...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		public static CraftSystem CraftSystem { get { return m_CraftSystem ?? (m_CraftSystem = new DefTailoring()); } }
		...
		public static bool IsColorable(Type type)
		{
			return m_TailorNonColorables.All(t => t != type);
		}

		private static readonly Type[] m_TailorNonColorables = new[] {typeof(OrcHelm)};

		private static readonly Type[] m_TailorColorables = new[]
		{
			typeof(GozaMatEastDeed), typeof(GozaMatSouthDeed), typeof(SquareGozaMatEastDeed), typeof(SquareGozaMatSouthDeed),
			typeof(BrocadeGozaMatEastDeed), typeof(BrocadeGozaMatSouthDeed), typeof(BrocadeSquareGozaMatEastDeed),
		...
		public override void InitCraftList()
		{
			...
			#region AOS
			index = AddCraft(typeof(FlowerGarland), 1011375, 1028965, 10.0, 35.0, typeof(Cloth), 1044286, 5, 1044287);
			...
			#region AOS
			index = AddCraft(typeof(FurCape), 1015269, 1028969, 35.0, 60.0, typeof(Cloth), 1044286, 13, 1044287);
			SetNeededExpansion(index, Expansion.AOS);
			index = AddCraft(typeof(GildedDress), 1015269, 1028973, 37.5, 62.5, typeof(Cloth), 1044286, 16, 1044287);
			SetNeededExpansion(index, Expansion.AOS);
			index = AddCraft(typeof(FormalShirt), 1015269, 1028975, 26.0, 51.0, typeof(Cloth), 1044286, 16, 1044287);
			SetNeededExpansion(index, Expansion.AOS);
			#endregion
			...
			#region AOS
			index = AddCraft(typeof(FurSarong), 1015279, 1028971, 35.0, 60.0, typeof(Cloth), 1044286, 12, 1044287);
			SetNeededExpansion(index, Expansion.AOS);
			#endregion
			...
			SetNeededExpansion(index, Expansion.SE);
			index = AddCraft(
				typeof(BrocadeSquareGozaMatEastDeed), 1015283, 1030411, 55.0, 80.0, typeof(Cloth), 1044286, 25, 1044287);
			SetNeededExpansion(index, Expansion.SE);
			index = AddCraft(
				typeof(BrocadeSquareGozaMatSouthDeed), 1015283, 1030410, 55.0, 80.0, typeof(Cloth), 1044286, 25, 1044287);
			SetNeededExpansion(index, Expansion.SE);
			#endregion
			...
			#region AOS
			index = AddCraft(typeof(FurBoots), 1015288, 1028967, 50.0, 75.0, typeof(Cloth), 1044286, 12, 1044287);
			SetNeededExpansion(index, Expansion.AOS);
			#endregion
			...
			AddCraft(typeof(StuddedCap), 1015300, "studded cap", 80.9, 105.9, typeof(Leather), 1044462, 4, 1044463);
