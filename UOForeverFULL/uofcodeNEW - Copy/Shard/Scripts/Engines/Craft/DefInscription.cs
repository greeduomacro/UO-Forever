...
namespace Server.Engines.Craft
{
	public class DefInscription : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( Spellbook ), 1044294, 1023834, 75.0, 105, typeof( BlankScroll ), 1044377, 8, 1044378 );

			/*index = AddCraft( typeof( Spellbook ), 1044294, "Full Spellbook", 75.0, 115, typeof( BlankScroll ), 1044377, 72, 1044378 );
			AddRes( index, typeof( BlackPearl ), 1044353, 17, 1044361 );
			AddRes( index, typeof( Bloodmoss ), 1044354, 26, 1044362 );
			AddRes( index, typeof( Garlic ), 1044355, 23, 1044363 );
			AddRes( index, typeof( Ginseng ), 1044356, 11, 1044364 );
			AddRes( index, typeof( MandrakeRoot ), 1044357, 38, 1044365 );
			AddRes( index, typeof( Nightshade ), 1044358, 16, 1044366 );
			AddRes( index, typeof( SulfurousAsh ), 1044359, 24, 1044367 );
			AddRes( index, typeof( SpidersSilk ), 1044360, 25, 1044368 );
			SetManaReq( index, 100 );
			AddRecipe( index, 1001 );*/
