	...
	public class DefBlacksmithy : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			*/
			...
			AddCraft(typeof(PlateChest), 1011078, 1046431, 75.0, 116.3, typeof(IronIngot), 1044036, 25, 1044037);
			AddCraft(typeof(FemalePlateChest), 1011078, 1046430, 44.1, 94.1, typeof(IronIngot), 1044036, 20, 1044037);

			#region AOS
			index = AddCraft(typeof(DragonBardingDeed), 1011078, 1053012, 72.5, 122.5, typeof(IronIngot), 1044036, 750, 1044037);
			...
			*/
			...
			#region AOS
			index = AddCraft(typeof(ChaosShield), 1011080, 1027107, 85.0, 135.0, typeof(IronIngot), 1044036, 25, 1044037);
			SetNeededExpansion(index, Expansion.AOS);
			index = AddCraft(typeof(OrderShield), 1011080, 1027108, 85.0, 135.0, typeof(IronIngot), 1044036, 25, 1044037);
			SetNeededExpansion(index, Expansion.AOS);
			#endregion
			...
			#region AOS
			index = AddCraft(typeof(Scepter), 1011084, 1029916, 21.4, 71.4, typeof(IronIngot), 1044036, 10, 1044037);
			SetNeededExpansion(index, Expansion.AOS);
			#endregion
            ...
            index = AddCraft(typeof(DragonGloves), 1011078, 1029795, 68.9, 118.9, typeof(RedScales), 1060883, 16, 1060884);
			SetUseSubRes2(index, true);

			index = AddCraft(
                typeof(DragonGorget), 1011078, "dragon gorget", 66.4, 116.4, typeof(RedScales), 1060883, 14, 1060884);
			SetUseSubRes2(index, true);

            index = AddCraft(typeof(DragonHelm), 1011078, 1029797, 72.6, 122.6, typeof(RedScales), 1060883, 20, 1060884);
			SetUseSubRes2(index, true);

            index = AddCraft(typeof(DragonLegs), 1011078, 1029799, 78.8, 128.8, typeof(RedScales), 1060883, 28, 1060884);
			SetUseSubRes2(index, true);

            index = AddCraft(typeof(DragonArms), 1011078, 1029815, 76.3, 126.3, typeof(RedScales), 1060883, 24, 1060884);
			SetUseSubRes2(index, true);

            index = AddCraft(typeof(DragonChest), 1011078, 1029793, 85.0, 135.0, typeof(RedScales), 1060883, 36, 1060884);
			SetUseSubRes2(index, true);
			#endregion

            #region Misc
            index = AddCraft(
                typeof(CannonBall2), "Other", "a cannon ball", 105.0, 120.0, typeof(IronIngot), "iron ingot", 100, 1044037);
            #endregion
