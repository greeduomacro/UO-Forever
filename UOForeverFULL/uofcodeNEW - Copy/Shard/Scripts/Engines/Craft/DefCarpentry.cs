...
namespace Server.Engines.Craft
{
	public class DefCarpentry : CraftSystem
	{
		...
		public static CraftSystem CraftSystem { get { return m_CraftSystem ?? (m_CraftSystem = new DefCarpentry()); } }
		...
		public override void InitCraftList()
		{
            ...
            AddCraft(typeof(GildedWoodenChest), 1044292, 1030255, 120.0, 200.0, typeof(Log), 1044041, 1000, 1044351);
            //AddCraft(typeof(GothicChest), 1044292, 1030255, 120.0, 160.0, typeof(Log), 1044041, 1000, 1044351);
            AddCraft(typeof(OrnateWoodenChest), 1044292, 1030253, 120.0, 200.0, typeof(Log), 1044041, 1000, 1044351);
            AddCraft(typeof(WoodenFootLocker), 1044292, 1030257, 120.0, 200.0, typeof(Log), 1044041, 1000, 1044351);
            AddCraft(typeof(FinishedWoodenChest), 1044292, 1030259, 120.0, 200.0, typeof(Log), 1044041, 1000, 1044351);
            AddCraft(typeof(ShortCabinet), 1044292, 1030263, 120.0, 200.0, typeof(Log), 1044041, 1000, 1044351);
            AddCraft(typeof(TallCabinet), 1044292, 1030261, 120.0, 200.0, typeof(Log), 1044041, 1000, 1044351);
            ...
            AddCraft(typeof(PlayerBBEast), 1044290, 1062420, 85.0, 100.0, typeof(Log), 1044041, 200, 1044351);
            AddCraft(typeof(PlayerBBSouth), 1044290, 1062421, 85.0, 100.0, typeof(Log), 1044041, 200, 1044351);
			...
			// Tailoring
			/*
			// Dressforms somehow don't have the right item id
            ...
            */
            ...
            // Can require over 100 skill for carpentry since there are powerscrolls
            // TODO: Verify the required skill amount
			AddSubRes(typeof(Log), 1072643, 00.0, 1044041, 1072652);
			AddSubRes(typeof(OakLog), 1072644, 101.0, 1044041, 1072652);
			AddSubRes(typeof(AshLog), 1072645, 105.0, 1044041, 1072652);
			AddSubRes(typeof(YewLog), 1072646, 106.0, 1044041, 1072652);
			AddSubRes(typeof(HeartwoodLog), 1072647, 110.0, 1044041, 1072652);
			AddSubRes(typeof(BloodwoodLog), 1072648, 115.0, 1044041, 1072652);
			AddSubRes(typeof(FrostwoodLog), 1072649, 116.0, 1044041, 1072652);
		}
	}
}