...
namespace Server.Engines.BulkOrders
{
	...
	public sealed class RewardItem
	{
		...
		public ConstructCallback Constructor { get; private set; }
	...
	{
		public int Points { get; private set; }
		public RewardItem[] Items { get; private set; }
		...
		public RewardItem AcquireItem()
		{
			...
			int totalWeight = Items.Sum(t => t.Weight);
	...
	public abstract class RewardCalculator
	{
		...
		{
			return ComputePoints(bod.Expansion, bod.AmountMax, bod.RequireExceptional, bod.Material, 1, bod.Type);
		}

		public virtual int ComputePoints(LargeBOD bod)
		{
			return ComputePoints(
				bod.Expansion, bod.AmountMax, bod.RequireExceptional, bod.Material, bod.Entries.Length, bod.Entries[0].Details.Type);
		}

		public virtual int ComputeGold(SmallBOD bod)
		{
			return ComputeGold(bod.Expansion, bod.AmountMax, bod.RequireExceptional, bod.Material, 1, bod.Type);
		}
	...
	public sealed class SmithRewardCalculator : RewardCalculator
	{
		...
		private static Item CreateRunicHammer(int type)
		{
			...
			{
				case 1:
					return new RunicHammer(CraftResource.Iron + type, 45);
				case 2:
					return new RunicHammer(CraftResource.Iron + type, 40);
				case 3:
					return new RunicHammer(CraftResource.Iron + type, 35);
				case 4:
					return new RunicHammer(CraftResource.Iron + type, 30);
				case 5:
					return new RunicHammer(CraftResource.Iron + type, 25);
				case 6:
					return new RunicHammer(CraftResource.Iron + type, 20);
				case 7:
					return new RunicHammer(CraftResource.Iron + type, 15);
				case 8:
					return new RunicHammer(CraftResource.Iron + type, 10);
			}
		...
		private static Item CreateAncientHammer(int type)
		{
			...
			{
				return new AncientSmithHammerWeapon(type);
			}
		...
		private readonly RewardType[] m_Types =
		{
			...
			new RewardType(
				...
				typeof(Longsword),
				typeof(Scimitar),
				/*typeof( ThinLongsword ),*/ typeof(VikingSword)),
			new RewardType(
				350, typeof(WarAxe), typeof(HammerPick), typeof(Mace), typeof(Maul), typeof(WarHammer), typeof(WarMace))
		};
		...
		private static readonly int[][][] m_GoldTable =
		{
			new[] // 1-part (regular)
			{
				new[] {150, 250, 250, 400, 400, 750, 750, 1200, 1200}, new[] {225, 375, 375, 600, 600, 1125, 1125, 1800, 1800},
				new[] {300, 500, 750, 800, 1050, 1500, 2250, 2400, 4000}
			},
			new[] // 1-part (exceptional)
			{
				new[] {250, 400, 400, 750, 750, 1500, 1500, 3000, 3000}, new[] {375, 600, 600, 1125, 1125, 2250, 2250, 4500, 4500},
			...
			{new[] {3000, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {4500, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {6000, 0, 0, 0, 0, 0, 0, 0, 0}},
			new[] // 2-part weapons (exceptional)
			{new[] {5000, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {7500, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {10000, 0, 0, 0, 0, 0, 0, 0, 0}},
			new[] // 5-part weapons (regular)
			{new[] {4000, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {6000, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {8000, 0, 0, 0, 0, 0, 0, 0, 0}},
			new[] // 5-part weapons (exceptional)
			{new[] {7500, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {11250, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {15000, 0, 0, 0, 0, 0, 0, 0, 0}},
			new[] // 6-part weapons (regular)
			{new[] {4000, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {6000, 0, 0, 0, 0, 0, 0, 0, 0}, new[] {10000, 0, 0, 0, 0, 0, 0, 0, 0}},
		...
		public SmithRewardCalculator()
		{
			Groups = new[]
			{
				new RewardGroup(0, new RewardItem(1, SturdyShovel)), new RewardGroup(25, new RewardItem(1, SturdyPickaxe)),
				new RewardGroup(
					50, new RewardItem(45, SturdyShovel), new RewardItem(45, SturdyPickaxe), new RewardItem(10, MiningGloves, 1)),
				new RewardGroup(
					200, new RewardItem(45, GargoylesPickaxe), new RewardItem(45, ProspectorsTool), new RewardItem(10, MiningGloves, 3))
				,
				new RewardGroup(
					400,
				...
				new RewardGroup(
					625, new RewardItem(3, RunicHammer, 2), new RewardItem(6, PowerScroll, 5), new RewardItem(1, ColoredAnvil)),
				new RewardGroup(650, new RewardItem(1, RunicHammer, 3)),
				new RewardGroup(
					675, new RewardItem(1, ColoredAnvil), new RewardItem(6, PowerScroll, 10), new RewardItem(3, RunicHammer, 3)),
				new RewardGroup(700, new RewardItem(1, RunicHammer, 4)), new RewardGroup(750, new RewardItem(1, AncientHammer, 10)),
				new RewardGroup(800, new RewardItem(1, PowerScroll, 15)), new RewardGroup(850, new RewardItem(1, AncientHammer, 15))
				, new RewardGroup(900, new RewardItem(1, PowerScroll, 20)), new RewardGroup(950, new RewardItem(1, RunicHammer, 5)),
				...
				new RewardGroup(1150, new RewardItem(1, RunicHammer, 7)), new RewardGroup(1200, new RewardItem(1, RunicHammer, 8))
			};
		}
	}
	...
	public sealed class TailorRewardCalculator : RewardCalculator
	{
		...
		public static int[][] m_ClothHues =
		{
			new[] {0x557, 0x488, 0x4F4, 0x48C, 0x483, 0x48A},
			new[] {0x55D, 0x48B, 0x4FB, 0x492, 0x486, 0x485}, new[] {0x490, 0x48E, 0x48D, 0x495, 0x491, 0x48F},
			new[] {0x455, 0x484, 0x497, 0x494, 0x482, 0x504}, new[] {0x4F2, 0x4AA, 0x4AC, 0x47E, 0XA5F, 0x4E9}
		};
		...
		public static int[] m_SandalHues =
		{
			0x557, 0x497, 0x170, 0x660, 0x488, 0x4E6, 0x482, 0x47E, 0x48F, 0x494, 0x484, 0x4AB
		};
		...
		private static Item CreateRunicKit(int type)
		{
			if (type == 1)
			{
				return new RunicSewingKit(CraftResource.RegularLeather + type, 45);
			}
			if (type == 2)
			{
				return new RunicSewingKit(CraftResource.RegularLeather + type, 30);
			}
			if (type == 3)
			{
		...
		{
			new[] // 1-part (regular)
			{new[] {150, 150, 300, 300}, new[] {225, 225, 450, 450}, new[] {300, 400, 600, 750}},
			new[] // 1-part (exceptional)
			{new[] {300, 300, 600, 600}, new[] {450, 450, 900, 900}, new[] {600, 750, 1200, 1800}},
			new[] // 4-part (regular)
			{new[] {4000, 4000, 5000, 5000}, new[] {6000, 6000, 7500, 7500}, new[] {8000, 10000, 10000, 15000}},
			new[] // 4-part (exceptional)
			{new[] {5000, 5000, 7500, 7500}, new[] {7500, 7500, 11250, 11250}, new[] {10000, 15000, 15000, 20000}},
			new[] // 5-part (regular)
			{new[] {5000, 5000, 7500, 7500}, new[] {7500, 7500, 11250, 11250}, new[] {10000, 15000, 15000, 20000}},
			new[] // 5-part (exceptional)
			{new[] {7500, 7500, 10000, 10000}, new[] {11250, 11250, 15000, 15000}, new[] {15000, 20000, 20000, 30000}},
			new[] // 6-part (regular)
			{new[] {7500, 7500, 10000, 10000}, new[] {11250, 11250, 15000, 15000}, new[] {15000, 20000, 20000, 30000}},
			new[] // 6-part (exceptional)
			{new[] {10000, 10000, 15000, 15000}, new[] {15000, 15000, 22500, 22500}, new[] {20000, 30000, 30000, 50000}}
		};
		...
		private static readonly int[][][] m_OldGoldTable =
		{
			...
			{new[] {300, 300, 600, 600}, new[] {450, 450, 900, 900}, new[] {600, 750, 1200, 1800}},
			new[] // 4-part (regular)
			{new[] {3000, 3000, 4000, 4000}, new[] {4500, 4500, 6000, 6000}, new[] {6000, 8000, 8000, 10000}},
			new[] // 4-part (exceptional)
			{new[] {4000, 4000, 5000, 5000}, new[] {6000, 6000, 7500, 7500}, new[] {8000, 10000, 10000, 15000}},
			new[] // 5-part (regular)
			{new[] {4000, 4000, 5000, 5000}, new[] {6000, 6000, 7500, 7500}, new[] {8000, 10000, 10000, 15000}},
		...
		public TailorRewardCalculator()
		{
			Groups = new[]
			{
				new RewardGroup(0, new RewardItem(1, Cloth, 0)), new RewardGroup(50, new RewardItem(1, Cloth, 1)),
				...
				new RewardGroup(300, new RewardItem(1, StretchedHide)), new RewardGroup(350, new RewardItem(1, RunicKit, 1)),
				new RewardGroup(400, new RewardItem(2, PowerScroll, 5), new RewardItem(3, Tapestry)),
				new RewardGroup(450, new RewardItem(1, BearRug)), new RewardGroup(500, new RewardItem(1, PowerScroll, 10)),
				new RewardGroup(550, new RewardItem(1, ClothingBlessDeed)), new RewardGroup(575, new RewardItem(1, PowerScroll, 15))
				, new RewardGroup(600, new RewardItem(1, RunicKit, 2)), new RewardGroup(650, new RewardItem(1, PowerScroll, 20)),
