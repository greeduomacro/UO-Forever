...
namespace Server.Factions
{
	public class HorseBreederGump : FactionGump
	{
		...
		public HorseBreederGump( PlayerMobile from, Faction faction ) : base( 20, 30 )
		{
            ...
            AddLabel(210, 205, m_Faction.Definition.HuePrimary, @"Primary Hue");
            AddRadio(175, 205, 9727, 9730, true, 1);
            AddLabel(210, 235, m_Faction.Definition.HueSecondary, @"Secondary Hue");
            AddRadio(175, 235, 9727, 9730, false, 2);
