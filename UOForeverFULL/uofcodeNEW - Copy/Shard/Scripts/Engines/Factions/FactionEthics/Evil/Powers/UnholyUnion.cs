...
{
    public sealed class UnholyUnion : Power
    {
        private static readonly SpellInfo m_Info = new SpellInfo("Unholy Union", "", 230);
        ...
        public UnholyUnion(Player Caster)
