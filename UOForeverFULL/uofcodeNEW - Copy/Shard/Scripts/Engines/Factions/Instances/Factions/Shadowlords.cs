			...
			Definition =
				new FactionDefinition(
					...
					new GuardDefinition[]
					{
						...
						new GuardDefinition( typeof( FactionDeathKnight ),	0x0F45, 7000, 3000, 4,		new TextDefinition( 1011512, "DEATH KNIGHT" ),	new TextDefinition( 1011503, "Hire Death Knight" ) ),
						new GuardDefinition( typeof( FactionNecromancer ),	0x13F8, 8000, 4000, 3,		new TextDefinition( 1011513, "SHADOW MAGE" ),	new TextDefinition( 1011504, "Hire Shadow Mage" ) ),
					}
				);
		}
	}
