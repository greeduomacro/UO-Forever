...
namespace Server.Engines.Quests.Samurai
{
	...
	public class YoungNinja : BaseCreature
	{
		...
		public YoungNinja() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			...
			AddItem( Immovable(new LeatherNinjaBelt()) );

			AddItem( Immovable(new Bandana( Utility.RandomNondyedHue()) ) );

			switch ( Utility.Random( 3 ) )
			{
				case 0: AddItem( Immovable(new Tessen()) ); break;
				case 1: AddItem( Immovable(new Kama()) ); break;
				default: AddItem( Immovable(new Lajatang()) ); break;
			}
