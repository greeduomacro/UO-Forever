...
namespace Server.Engines.Quests.Necro
{
	public class Horus : BaseQuester
	{
		...
		{
			AddItem( Immovable(SetHue( new PlateLegs(), 0x849 )) );
			AddItem( Immovable(SetHue( new PlateChest(), 0x849 )) );
			AddItem( Immovable(SetHue( new PlateArms(), 0x849 )) );
			AddItem( Immovable(SetHue( new PlateGloves(), 0x849 )) );
			AddItem( Immovable(SetHue( new PlateGorget(), 0x849 )) );

			AddItem( Immovable(SetHue( new Bardiche(), 0x482 )) );

			AddItem( Immovable(SetHue( new Boots(), 0x001 )) );
			AddItem( Immovable(SetHue( new Cloak(), 0x482 )) );
