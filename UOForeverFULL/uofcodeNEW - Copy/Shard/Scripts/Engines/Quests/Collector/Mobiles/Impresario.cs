...
namespace Server.Engines.Quests.Collector
{
	public class Impresario : BaseQuester
	{
		...
		{
			AddItem( Immovable(new FancyShirt( Utility.RandomDyedHue() )) );
			AddItem( Immovable(new LongPants( Utility.RandomNondyedHue() )) );
			AddItem( Immovable(new Shoes( Utility.RandomNeutralHue() )) );
