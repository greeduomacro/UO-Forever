...
namespace Server.Engines.Quests.Collector
{
	public class ElwoodMcCarrin : BaseQuester
	{
		...
		{
			AddItem( Immovable(new FancyShirt()) );
			AddItem( Immovable(new LongPants( 0x544 )) );
			AddItem( Immovable(new Shoes( 0x454 )) );
			AddItem( Immovable(new JesterHat( 0x4D2 )) );
			AddItem( Immovable(new FullApron( 0x4D2 )) );
