...
namespace Server.Engines.Doom
{
    ...
    public class GauntletSpawner : Item
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public BaseDoor Door { get { return m_Door; } set { m_Door = value; } }

        [CommandProperty(AccessLevel.GameMaster)]
        public BaseAddon Addon { get { return m_Addon; } set { m_Addon = value; } }

        [CommandProperty(AccessLevel.GameMaster)]
        public GauntletSpawner Sequence { get { return m_Sequence; } set { m_Sequence = value; } }
        ...
        public bool HasCompleted
        {
            get
            {
                ...
                return m_Creatures.All(mob => mob.Deleted);
            }
        }

        [CommandProperty(AccessLevel.GameMaster)]
        public Rectangle2D RegionBounds { get { return m_RegionBounds; } set { m_RegionBounds = value; } }
        ...
        public GauntletSpawnerState State
        {
            ...
            set
            {
                ...
                if (m_State == GauntletSpawnerState.InProgress)
                {
                    ...
                    m_Timer = Timer.DelayCall(TimeSpan.FromSeconds(1.0), TimeSpan.FromSeconds(1.0),
                        Slice);
                }
                else
                {
        ...
        public List<Mobile> Creatures { get { return m_Creatures; } set { m_Creatures = value; } }

        public List<BaseTrap> Traps { get { return m_Traps; } set { m_Traps = value; } }
        ...
        {
            foreach (Mobile t in m_Creatures)
            {
                t.Delete();
            }
        ...
        public override string DefaultName { get { return "doom spawner"; } }
        ...
        {
            CommandSystem.Register("GenGauntlet", AccessLevel.Administrator,
                GenGauntlet_OnCommand);
        }

        public static void CreateTeleporter(int xFrom, int yFrom, int xTo, int yTo)
        {
            var telePad = new Static(0x1822);
            var teleItem = new Teleporter(new Point3D(xTo, yTo, -1), Map.Malas, false);
