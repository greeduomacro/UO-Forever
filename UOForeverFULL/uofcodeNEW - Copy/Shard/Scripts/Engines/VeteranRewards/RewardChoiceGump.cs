...
namespace Server.Engines.VeteranRewards
{
	public class RewardChoiceGump : Gump
	{
		...
		private static readonly string m_ThankYouMessage = "<B>" + ShardInfo.DisplayName + "Rewards Program</B><BR>" +
									"Thank you for being a part of the " + ShardInfo.DisplayName + " community for a full {0}.  " +
									"As a token of our appreciation,  you may select from the following in-game reward items listed below.  " +
									"The gift items will be attributed to the character you have logged-in with at the time you chose the item(s).  " +
									"The number of rewards you are entitled to are listed below and are for your entire account.  " +
									"To read more about these rewards before making a selection, feel free to visit the " + ShardInfo.Website + " site at " +
									"<A HREF=\"" + ShardInfo.Website + "/rewards\">" + ShardInfo.Website + "</A>.";
