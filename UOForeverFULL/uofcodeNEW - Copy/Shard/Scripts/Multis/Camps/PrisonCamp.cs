...
{
	public class PrisonCamp : BaseCamp
	{
		public virtual Mobile Prisonmate { get { return new Prisonmate(); } }
		...
		public override void AddComponents()
		{
			...
			for (int i = 0; i < 4; i ++)
			{
				AddMobile(Prisonmate, 6, Utility.RandomMinMax(-7, 7), Utility.RandomMinMax(-7, 7), 0);
			}
		...
		public PrisonCamp(Serial serial)
			: base(serial)
		{ }
