...
namespace Server.Misc
{
	public class Strandedness
	{
		...
		public static void EventSink_Login( LoginEventArgs e )
		{
            ...
            MoveStrandedMobile(from);
		}

        public static void MoveStrandedMobile(Mobile from)
        {
            if (from == null || from.Deleted)
                return;
            Map map = Map.Felucca; // from.Map;
            ...
            */
            ...
            {
                from.Location = new Point3D(1438, 1690, 0); // west brit bank
            }
        }
	}
}